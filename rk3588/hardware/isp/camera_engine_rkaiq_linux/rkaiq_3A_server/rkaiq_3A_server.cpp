...
#define IQ_PATH "/vendor/etc/iqfiles"
...
int rkaiq_get_media_info(struct rkaiq_media_info *media_info)
{
    ...
    ERR("rkisp-isp-subdev:%s rkisp-input-params:%s rkisp-statistics:%s rkisp_mainpath:%s sensor_entity_name:%s\n",
        media_info->sd_isp_path, media_info->vd_params_path, media_info->vd_stats_path, media_info->mainpath, media_info->sensor_entity_name);
