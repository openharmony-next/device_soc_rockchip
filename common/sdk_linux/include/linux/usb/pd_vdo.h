 ...
 * <4:0>    :: command
 */
#define VDO(vid, type, ver, custom) (((vid) << 16) | ((type) << 15) | ((ver) << 13) | ((custom)&0x7FFF))
...
#define VDO_IDH(usbh, usbd, ufp_cable, is_modal, dfp, conn, vid)                                                       \
    ((usbh) << 31 | (usbd) << 30 | ((ufp_cable)&0x7) << 27 | (is_modal) << 26 | ((dfp)&0x7) << 23 |                    \
     ((conn)&0x3) << 21 | ((vid)&0xffff))
...
#define VDO_UFP(ver, cap, conn, vcpwr, vcr, vbr, alt, spd)                                                             \
    (((ver)&0x7) << 29 | ((cap)&0xf) << 24 | ((conn)&0x3) << 22 | ((vcpwr)&0x7) << 8 | (vcr) << 7 | (vbr) << 6 |       \
     ((alt)&0x7) << 3 | ((spd)&0x7))
...
#define VDO_DFP(ver, cap, conn, pnum) (((ver)&0x7) << 29 | ((cap)&0x7) << 24 | ((conn)&0x3) << 22 | ((pnum)&0x1f))
...
#define VDO_CABLE(hw, fw, cbl, lat, term, tx1d, tx2d, rx1d, rx2d, cur, vps, sopp, usbss)                               \
    (((hw)&0x7) << 28 | ((fw)&0x7) << 24 | ((cbl)&0x3) << 18 | ((lat)&0x7) << 13 | ((term)&0x3) << 11 | (tx1d) << 10 | \
     (tx2d) << 9 | (rx1d) << 8 | (rx2d) << 7 | ((cur)&0x3) << 5 | (vps) << 4 | (sopp) << 3 | ((usbss)&0x7))
#define VDO_PCABLE(hw, fw, ver, conn, lat, term, vbm, cur, spd)                                                        \
    (((hw)&0xf) << 28 | ((fw)&0xf) << 24 | ((ver)&0x7) << 21 | ((conn)&0x3) << 18 | ((lat)&0xf) << 13 |                \
     ((term)&0x3) << 11 | ((vbm)&0x3) << 9 | ((cur)&0x3) << 5 | ((spd)&0x7))
#define VDO_ACABLE1(hw, fw, ver, conn, lat, term, vbm, sbu, sbut, cur, vbt, sopp, spd)                                 \
    (((hw)&0xf) << 28 | ((fw)&0xf) << 24 | ((ver)&0x7) << 21 | ((conn)&0x3) << 18 | ((lat)&0xf) << 13 |                \
     ((term)&0x3) << 11 | ((vbm)&0x3) << 9 | (sbu) << 8 | (sbut) << 7 | ((cur)&0x3) << 5 | (vbt) << 4 | (sopp) << 3 |  \
     ((spd)&0x7))
...
#define VDO_ACABLE2(mtemp, stemp, u3p, trans, phy, ele, u4, hops, u2, u32, lane, iso, gen)                             \
    (((mtemp)&0xff) << 24 | ((stemp)&0xff) << 16 | ((u3p)&0x7) << 12 | (trans) << 11 | (phy) << 10 | (ele) << 9 |      \
     (u4) << 8 | ((hops)&0x3) << 6 | (u2) << 5 | (u32) << 4 | (lane) << 3 | (iso) << 2 | (gen))
...
#define VDO_AMA(hw, fw, tx1d, tx2d, rx1d, rx2d, vcpwr, vcr, vbr, usbss)                                                \
    (((hw)&0x7) << 28 | ((fw)&0x7) << 24 | (tx1d) << 11 | (tx2d) << 10 | (rx1d) << 9 | (rx2d) << 8 |                   \
     ((vcpwr)&0x7) << 5 | (vcr) << 4 | (vbr) << 3 | ((usbss)&0x7))
...
#define VDO_VPD(hw, fw, ver, vbm, curr, vbi, gi, ct)                                                                   \
    (((hw)&0xf) << 28 | ((fw)&0xf) << 24 | ((ver)&0x7) << 21 | ((vbm)&0x3) << 15 | (curr) << 14 | ((vbi)&0x3f) << 7 |  \
     ((gi)&0x3f) << 1 | (ct))
