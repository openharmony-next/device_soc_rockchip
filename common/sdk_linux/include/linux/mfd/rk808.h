...
#define RK_REG_BITS 8
#define RK_VAL_BITS 8
#define RK_REG_VAL_ZERO 0
#define RK_REG_VAL_THREE 3
#define RK_REG_SHIFT_MASK_ZERO 0
#define RK_REG_SHIFT_MASK_ONE 1
#define RK_REG_SHIFT_MASK_TWO 2
#define RK_REG_SHIFT_MASK_THREE 3
#define RK_REG_SHIFT_MASK_FOUR 4
#define RK_REG_SHIFT_MASK_FIVE 5
#define RK_REG_SHIFT_MASK_SIX 6
#define RK_REG_SHIFT_MASK_SEVEN 7
#define RK_REG_SHIFT_MASK_EIGHT 8
#define RK_DELAY_COUNT_TWO_MS 2
#define RK_DELAY_COUNT_TEN_MS 10
#define RK_SSCAN_RET_RESULT_ONE 1
#define RK_SSCAN_RET_RESULT_TWO 2
#define RK_SSCAN_RET_RESULT_THREE 3
#define RK_INPUT_MASK 0xff
#define RK_BYTE_HIGH_FOUR_BIT_MASK 0xf0
#define RK_BYTE_LOW_FOUR_BIT_MASK 0x0f
#define RK_BYTE_FOUR_BIT_SHIFT_MASK 4
#define RK_POWER_EN_REG_VALUE_ZERO 0
#define RK_POWER_EN_REG_VALUE_ONE 1
#define RK_POWER_EN_REG_VALUE_TWO 2
#define RK_POWER_EN_REG_VALUE_THREE 3
