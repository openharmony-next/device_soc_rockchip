...
#define INTEL_GUC_MSG_GET(T, m) (((m)&INTEL_GUC_MSG_##T##_MASK) >> INTEL_GUC_MSG_##T##_SHIFT)
#define INTEL_GUC_MSG_TO_TYPE(m) INTEL_GUC_MSG_GET(TYPE, m)
#define INTEL_GUC_MSG_TO_DATA(m) INTEL_GUC_MSG_GET(DATA, m)
#define INTEL_GUC_MSG_TO_CODE(m) INTEL_GUC_MSG_GET(CODE, m)
...
#define INTEL_GUC_MSG_TYPE_IS(T, m) (INTEL_GUC_MSG_TO_TYPE(m) == INTEL_GUC_MSG_TYPE_##T)
#define INTEL_GUC_MSG_IS_REQUEST(m) INTEL_GUC_MSG_TYPE_IS(REQUEST, m)
#define INTEL_GUC_MSG_IS_RESPONSE(m) INTEL_GUC_MSG_TYPE_IS(RESPONSE, m)
