...
static void RGA2_set_reg_src_info(RK_U8 *base, struct rga2_req *msg)
{
    ...
    RK_U32 ydiv = 1, xdiv = RGA2_INDEX_TW;
    RK_U8  yuv10 = 0;
    ...
    {
        case RGA2_FORMAT_RGBA_8888    : src0_format = 0x0; pixel_width = RGA2_INDEX_FO; break;
        case RGA2_FORMAT_BGRA_8888    : src0_format = 0x0; src0_rb_swp = 0x1; pixel_width = RGA2_INDEX_FO; break;
        case RGA2_FORMAT_RGBX_8888    : src0_format = 0x1; pixel_width = RGA2_INDEX_FO; msg->src_trans_mode &= 0x07; break;
        case RGA2_FORMAT_BGRX_8888    : src0_format = 0x1; src0_rb_swp = 0x1; pixel_width = RGA2_INDEX_FO; msg->src_trans_mode &= 0x07; break;
        case RGA2_FORMAT_RGB_888      : src0_format = 0x2; src0_rgb_pack = 1; pixel_width = RGA2_INDEX_TH; msg->src_trans_mode &= 0x07; break;
        case RGA2_FORMAT_BGR_888      : src0_format = 0x2; src0_rgb_pack = 1; src0_rb_swp = 1; pixel_width = RGA2_INDEX_TH; msg->src_trans_mode &= 0x07; break;
        case RGA2_FORMAT_RGB_565      : src0_format = 0x4; pixel_width = RGA2_INDEX_TW; msg->src_trans_mode &= 0x07; break;
        case RGA2_FORMAT_RGBA_5551    : src0_format = 0x5; pixel_width = RGA2_INDEX_TW; src0_rb_swp = 0x1; break;
        case RGA2_FORMAT_RGBA_4444    : src0_format = 0x6; pixel_width = RGA2_INDEX_TW; src0_rb_swp = 0x1; break;
        case RGA2_FORMAT_BGR_565      : src0_format = 0x4; pixel_width = RGA2_INDEX_TW; msg->src_trans_mode &= 0x07; src0_rb_swp = 0x1; break;
        case RGA2_FORMAT_BGRA_5551    : src0_format = 0x5; pixel_width = RGA2_INDEX_TW; break;
        case RGA2_FORMAT_BGRA_4444    : src0_format = 0x6; pixel_width = RGA2_INDEX_TW; break;

        /* ARGB */
        /* In colorkey mode, xrgb/xbgr does not need to enable the alpha channel */
        case RGA2_FORMAT_ARGB_8888    : src0_format = 0x0; pixel_width = RGA2_INDEX_FO; src0_alpha_swp = 1; break;
        case RGA2_FORMAT_ABGR_8888    : src0_format = 0x0; pixel_width = RGA2_INDEX_FO; src0_alpha_swp = 1; src0_rb_swp = 0x1; break;
        case RGA2_FORMAT_XRGB_8888    : src0_format = 0x1; pixel_width = RGA2_INDEX_FO; src0_alpha_swp = 1; msg->src_trans_mode &= 0x07; break;
        case RGA2_FORMAT_XBGR_8888    : src0_format = 0x1; pixel_width = RGA2_INDEX_FO; src0_alpha_swp = 1; src0_rb_swp = 0x1; msg->src_trans_mode &= 0x07; break;
        case RGA2_FORMAT_ARGB_5551    : src0_format = 0x5; pixel_width = RGA2_INDEX_TW; src0_alpha_swp = 1; break;
        case RGA2_FORMAT_ABGR_5551    : src0_format = 0x5; pixel_width = RGA2_INDEX_TW; src0_alpha_swp = 1; src0_rb_swp = 0x1; break;
        case RGA2_FORMAT_ARGB_4444    : src0_format = 0x6; pixel_width = RGA2_INDEX_TW; src0_alpha_swp = 1; break;
        case RGA2_FORMAT_ABGR_4444    : src0_format = 0x6; pixel_width = RGA2_INDEX_TW; src0_alpha_swp = 1; src0_rb_swp = 0x1; break;

        case RGA2_FORMAT_YVYU_422     : src0_format = 0x7; pixel_width = RGA2_INDEX_TW; src0_cbcr_swp = 1; src0_rb_swp = 0x1; break;//rbswap=ycswap
        case RGA2_FORMAT_VYUY_422     : src0_format = 0x7; pixel_width = RGA2_INDEX_TW; src0_cbcr_swp = 1; src0_rb_swp = 0x0; break;
        case RGA2_FORMAT_YUYV_422     : src0_format = 0x7; pixel_width = RGA2_INDEX_TW; src0_cbcr_swp = 0; src0_rb_swp = 0x1; break;
        case RGA2_FORMAT_UYVY_422     : src0_format = 0x7; pixel_width = RGA2_INDEX_TW; src0_cbcr_swp = 0; src0_rb_swp = 0x0; break;

        case RGA2_FORMAT_YCbCr_422_SP : src0_format = 0x8; xdiv = 1; ydiv = 1; break;
        case RGA2_FORMAT_YCbCr_422_P  : src0_format = 0x9; xdiv = RGA2_INDEX_TW; ydiv = 1; break;
        case RGA2_FORMAT_YCbCr_420_SP : src0_format = 0xa; xdiv = 1; ydiv = RGA2_INDEX_TW; break;
        case RGA2_FORMAT_YCbCr_420_P  : src0_format = 0xb; xdiv = RGA2_INDEX_TW; ydiv = RGA2_INDEX_TW; break;
        case RGA2_FORMAT_YCrCb_422_SP : src0_format = 0x8; xdiv = 1; ydiv = 1; src0_cbcr_swp = 1; break;
        case RGA2_FORMAT_YCrCb_422_P  : src0_format = 0x9; xdiv = RGA2_INDEX_TW; ydiv = 1; src0_cbcr_swp = 1; break;
        case RGA2_FORMAT_YCrCb_420_SP : src0_format = 0xa; xdiv = 1; ydiv = RGA2_INDEX_TW; src0_cbcr_swp = 1; break;
        case RGA2_FORMAT_YCrCb_420_P  : src0_format = 0xb; xdiv = RGA2_INDEX_TW; ydiv = RGA2_INDEX_TW; src0_cbcr_swp = 1; break;

        case RGA2_FORMAT_YCbCr_420_SP_10B : src0_format = 0xa; xdiv = 1; ydiv = RGA2_INDEX_TW; yuv10 = 1; break;
        case RGA2_FORMAT_YCrCb_420_SP_10B : src0_format = 0xa; xdiv = 1; ydiv = RGA2_INDEX_TW; src0_cbcr_swp = 1; yuv10 = 1; break;
    ...
    reg = ((reg & (~m_RGA2_SRC_INFO_SW_SW_SRC_MIR_MODE)) | (s_RGA2_SRC_INFO_SW_SW_SRC_MIR_MODE((msg->rotate_mode >> RGA2_INDEX_FO) & 0x3)));
    ...
    reg = ((reg & (~m_RGA2_SRC_INFO_SW_SW_SRC_DITHER_UP_E)) | (s_RGA2_SRC_INFO_SW_SW_SRC_DITHER_UP_E((msg->alpha_rop_flag >> RGA2_INDEX_FO) & 0x1)));
    reg = ((reg & (~m_RGA2_SRC_INFO_SW_SW_VSP_MODE_SEL)) | (s_RGA2_SRC_INFO_SW_SW_VSP_MODE_SEL((msg->scale_bicu_mode>>RGA2_INDEX_FO))));
    ...
    if (src_fmt_yuv400_en == 1) {
         ...
         */
        *bRGA_SRC_BASE0 = (RK_U32)(msg->src.yrgb_addr + msg->src.y_offset * (stride<<RGA2_INDEX_TW) + msg->src.x_offset * pixel_width);
...
static void RGA2_set_reg_dst_info(u8 *base, struct rga2_req *msg)
{
    ...
    {
        case RGA2_FORMAT_RGBA_8888    : src1_format = 0x0; spw = RGA2_INDEX_FO; break;
        case RGA2_FORMAT_BGRA_8888    : src1_format = 0x0; src1_rb_swp = 0x1; spw = RGA2_INDEX_FO; break;
        case RGA2_FORMAT_RGBX_8888    : src1_format = 0x1; spw = RGA2_INDEX_FO; break;
        case RGA2_FORMAT_BGRX_8888    : src1_format = 0x1; src1_rb_swp = 0x1; spw = RGA2_INDEX_FO; break;
        case RGA2_FORMAT_RGB_888      : src1_format = 0x2; src1_rgb_pack = 1; spw = RGA2_INDEX_TH; break;
        case RGA2_FORMAT_BGR_888      : src1_format = 0x2; src1_rgb_pack = 1; src1_rb_swp = 1; spw = RGA2_INDEX_TH; break;
        case RGA2_FORMAT_RGB_565      : src1_format = 0x4; spw = RGA2_INDEX_TW; break;
        case RGA2_FORMAT_RGBA_5551    : src1_format = 0x5; spw = RGA2_INDEX_TW; src1_rb_swp = 0x1; break;
        case RGA2_FORMAT_RGBA_4444    : src1_format = 0x6; spw = RGA2_INDEX_TW; src1_rb_swp = 0x1; break;
        case RGA2_FORMAT_BGR_565      : src1_format = 0x4; spw = RGA2_INDEX_TW; src1_rb_swp = 0x1; break;
        case RGA2_FORMAT_BGRA_5551    : src1_format = 0x5; spw = RGA2_INDEX_TW; break;
        case RGA2_FORMAT_BGRA_4444    : src1_format = 0x6; spw = RGA2_INDEX_TW; break;

        /* ARGB */
        case RGA2_FORMAT_ARGB_8888    : src1_format = 0x0; spw = RGA2_INDEX_FO; src1_alpha_swp = 1; break;
        case RGA2_FORMAT_ABGR_8888    : src1_format = 0x0; spw = RGA2_INDEX_FO; src1_alpha_swp = 1; src1_rb_swp = 0x1; break;
        case RGA2_FORMAT_XRGB_8888    : src1_format = 0x1; spw = RGA2_INDEX_FO; src1_alpha_swp = 1; break;
        case RGA2_FORMAT_XBGR_8888    : src1_format = 0x1; spw = RGA2_INDEX_FO; src1_alpha_swp = 1; src1_rb_swp = 0x1; break;
        case RGA2_FORMAT_ARGB_5551    : src1_format = 0x5; spw = RGA2_INDEX_TW; src1_alpha_swp = 1; break;
        case RGA2_FORMAT_ABGR_5551    : src1_format = 0x5; spw = RGA2_INDEX_TW; src1_alpha_swp = 1; src1_rb_swp = 0x1; break;
        case RGA2_FORMAT_ARGB_4444    : src1_format = 0x6; spw = RGA2_INDEX_TW; src1_alpha_swp = 1; break;
        case RGA2_FORMAT_ABGR_4444    : src1_format = 0x6; spw = RGA2_INDEX_TW; src1_alpha_swp = 1; src1_rb_swp = 0x1; break;
        default                       : spw = RGA2_INDEX_FO; break;
    };
    ...
    {
        case RGA2_FORMAT_RGBA_8888    : dst_format = 0x0; dpw = RGA2_INDEX_FO; break;
        case RGA2_FORMAT_BGRA_8888    : dst_format = 0x0; dst_rb_swp = 0x1; dpw = RGA2_INDEX_FO; break;
        case RGA2_FORMAT_RGBX_8888    : dst_format = 0x1; dpw = RGA2_INDEX_FO; break;
        case RGA2_FORMAT_BGRX_8888    : dst_format = 0x1; dst_rb_swp = 0x1; dpw = RGA2_INDEX_FO; break;
        case RGA2_FORMAT_RGB_888      : dst_format = 0x2; dst_rgb_pack = 1; dpw = RGA2_INDEX_TH; break;
        case RGA2_FORMAT_BGR_888      : dst_format = 0x2; dst_rgb_pack = 1; dst_rb_swp = 1; dpw = RGA2_INDEX_TH; break;
        case RGA2_FORMAT_RGB_565      : dst_format = 0x4; dpw = RGA2_INDEX_TW; break;
        case RGA2_FORMAT_RGBA_5551    : dst_format = 0x5; dpw = RGA2_INDEX_TW; dst_rb_swp = 0x1; break;
        case RGA2_FORMAT_RGBA_4444    : dst_format = 0x6; dpw = RGA2_INDEX_TW; dst_rb_swp = 0x1; break;
        case RGA2_FORMAT_BGR_565      : dst_format = 0x4; dpw = RGA2_INDEX_TW; dst_rb_swp = 0x1; break;
        case RGA2_FORMAT_BGRA_5551    : dst_format = 0x5; dpw = RGA2_INDEX_TW; break;
        case RGA2_FORMAT_BGRA_4444    : dst_format = 0x6; dpw = RGA2_INDEX_TW; break;

        /* ARGB */
        case RGA2_FORMAT_ARGB_8888    : dst_format = 0x0; dpw = RGA2_INDEX_FO; dst_alpha_swp = 1; break;
        case RGA2_FORMAT_ABGR_8888    : dst_format = 0x0; dpw = RGA2_INDEX_FO; dst_alpha_swp = 1; dst_rb_swp = 0x1; break;
        case RGA2_FORMAT_XRGB_8888    : dst_format = 0x1; dpw = RGA2_INDEX_FO; dst_alpha_swp = 1; break;
        case RGA2_FORMAT_XBGR_8888    : dst_format = 0x1; dpw = RGA2_INDEX_FO; dst_alpha_swp = 1; dst_rb_swp = 0x1; break;
        case RGA2_FORMAT_ARGB_5551    : dst_format = 0x5; dpw = RGA2_INDEX_TW; dst_alpha_swp = 1; break;
        case RGA2_FORMAT_ABGR_5551    : dst_format = 0x5; dpw = RGA2_INDEX_TW; dst_alpha_swp = 1; dst_rb_swp = 0x1; break;
        case RGA2_FORMAT_ARGB_4444    : dst_format = 0x6; dpw = RGA2_INDEX_TW; dst_alpha_swp = 1; break;
        case RGA2_FORMAT_ABGR_4444    : dst_format = 0x6; dpw = RGA2_INDEX_TW; dst_alpha_swp = 1; dst_rb_swp = 0x1; break;

        case RGA2_FORMAT_YCbCr_422_SP : dst_format = 0x8; x_div = 1; y_div = 1; break;
        case RGA2_FORMAT_YCbCr_422_P  : dst_format = 0x9; x_div = RGA2_INDEX_TW; y_div = 1; break;
        case RGA2_FORMAT_YCbCr_420_SP : dst_format = 0xa; x_div = 1; y_div = RGA2_INDEX_TW; break;
        case RGA2_FORMAT_YCbCr_420_P  : dst_format = 0xb; dst_cbcr_swp = 1; x_div = RGA2_INDEX_TW; y_div = RGA2_INDEX_TW; break;
        case RGA2_FORMAT_YCrCb_422_SP : dst_format = 0x8; dst_cbcr_swp = 1; x_div = 1; y_div = 1; break;
        case RGA2_FORMAT_YCrCb_422_P  : dst_format = 0x9; dst_cbcr_swp = 1; x_div = RGA2_INDEX_TW; y_div = 1; break;
        case RGA2_FORMAT_YCrCb_420_SP : dst_format = 0xa; dst_cbcr_swp = 1; x_div = 1; y_div = RGA2_INDEX_TW; break;
        case RGA2_FORMAT_YCrCb_420_P  : dst_format = 0xb; x_div = RGA2_INDEX_TW; y_div = RGA2_INDEX_TW; break;
        ...
        case RGA2_FORMAT_YUYV_422     : dst_format = 0xe; dpw = RGA2_INDEX_TW; dst_cbcr_swp = 1; break;
        case RGA2_FORMAT_YVYU_422     : dst_format = 0xe; dpw = RGA2_INDEX_TW; break;
        case RGA2_FORMAT_YUYV_420     : dst_format = 0xf; dpw = RGA2_INDEX_TW; dst_cbcr_swp = 1; break;
        case RGA2_FORMAT_YVYU_420     : dst_format = 0xf; dpw = RGA2_INDEX_TW; break;
        case RGA2_FORMAT_UYVY_422     : dst_format = 0xc; dpw = RGA2_INDEX_TW; dst_cbcr_swp = 1; break;
        case RGA2_FORMAT_VYUY_422     : dst_format = 0xc; dpw = RGA2_INDEX_TW; break;
        case RGA2_FORMAT_UYVY_420     : dst_format = 0xd; dpw = RGA2_INDEX_TW; dst_cbcr_swp = 1; break;
        case RGA2_FORMAT_VYUY_420     : dst_format = 0xd; dpw = RGA2_INDEX_TW; break;
    };
    ...
    reg = ((reg & (~m_RGA2_DST_INFO_SW_DITHER_UP_E)) | (s_RGA2_DST_INFO_SW_DITHER_UP_E(msg->alpha_rop_flag >> RGA2_INDEX_FI)));
    reg = ((reg & (~m_RGA2_DST_INFO_SW_DITHER_DOWN_E)) | (s_RGA2_DST_INFO_SW_DITHER_DOWN_E(msg->alpha_rop_flag >> RGA2_INDEX_SI)));
    reg = ((reg & (~m_RGA2_DST_INFO_SW_DITHER_MODE)) | (s_RGA2_DST_INFO_SW_DITHER_MODE(msg->dither_mode)));
    reg = ((reg & (~m_RGA2_DST_INFO_SW_DST_CSC_MODE)) | (s_RGA2_DST_INFO_SW_DST_CSC_MODE(msg->yuv2rgb_mode >> RGA2_INDEX_TW)));
    reg = ((reg & (~m_RGA2_DST_INFO_SW_CSC_CLIP_MODE)) | (s_RGA2_DST_INFO_SW_CSC_CLIP_MODE(msg->yuv2rgb_mode >> RGA2_INDEX_FO)));
    /* full csc enable */
    ...
    reg = ((reg & (~m_RGA2_DST_INFO_SW_SRC1_CSC_MODE)) | (s_RGA2_DST_INFO_SW_SRC1_CSC_MODE(msg->yuv2rgb_mode >> RGA2_INDEX_FI)));
    reg = ((reg & (~m_RGA2_DST_INFO_SW_SRC1_CSC_CLIP_MODE)) | (s_RGA2_DST_INFO_SW_SRC1_CSC_CLIP_MODE(msg->yuv2rgb_mode >> RGA2_INDEX_SE)));
    ...
    *bRGA_DST_VIR_INFO = d_stride | (s_stride << RGA2_INDEX_SIX);
    if ((msg->dst.vir_w % RGA2_INDEX_TW != 0) &&
    ...
    if (dst_nn_quantize_en) {
        *RGA_DST_NN_QUANTIZE_SCALE = (msg->gr_color.gr_x_r & 0xffff) | (msg->gr_color.gr_x_g << 10) | (msg->gr_color.gr_x_b << RGA2_INDEX_TWEN);
        *RGA_DST_NN_QUANTIZE_OFFSET = (msg->gr_color.gr_y_r & 0xffff) | (msg->gr_color.gr_y_g << 10) | (msg->gr_color.gr_y_b << RGA2_INDEX_TWEN);
    }
...
static void RGA2_set_reg_alpha_info(u8 *base, struct rga2_req *msg)
{
    ...
    reg1 = ((reg1 & (~m_RGA2_ALPHA_CTRL1_SW_DST_COLOR_M0)) | (s_RGA2_ALPHA_CTRL1_SW_DST_COLOR_M0(msg->alpha_mode_0 >> RGA2_INDEX_FIF)));
    reg1 = ((reg1 & (~m_RGA2_ALPHA_CTRL1_SW_SRC_COLOR_M0)) | (s_RGA2_ALPHA_CTRL1_SW_SRC_COLOR_M0(msg->alpha_mode_0 >> RGA2_INDEX_SE)));
    reg1 = ((reg1 & (~m_RGA2_ALPHA_CTRL1_SW_DST_FACTOR_M0)) | (s_RGA2_ALPHA_CTRL1_SW_DST_FACTOR_M0(msg->alpha_mode_0 >> RGA2_INDEX_TWE)));
    reg1 = ((reg1 & (~m_RGA2_ALPHA_CTRL1_SW_SRC_FACTOR_M0)) | (s_RGA2_ALPHA_CTRL1_SW_SRC_FACTOR_M0(msg->alpha_mode_0 >> RGA2_INDEX_FO)));
    reg1 = ((reg1 & (~m_RGA2_ALPHA_CTRL1_SW_DST_ALPHA_CAL_M0)) | (s_RGA2_ALPHA_CTRL1_SW_DST_ALPHA_CAL_M0(msg->alpha_mode_0 >> RGA2_INDEX_EIE)));
    reg1 = ((reg1 & (~m_RGA2_ALPHA_CTRL1_SW_SRC_ALPHA_CAL_M0)) | (s_RGA2_ALPHA_CTRL1_SW_SRC_ALPHA_CAL_M0(msg->alpha_mode_0 >> RGA2_INDEX_TH)));
    reg1 = ((reg1 & (~m_RGA2_ALPHA_CTRL1_SW_DST_BLEND_M0)) | (s_RGA2_ALPHA_CTRL1_SW_DST_BLEND_M0(msg->alpha_mode_0 >> RGA2_INDEX_NI)));
    reg1 = ((reg1 & (~m_RGA2_ALPHA_CTRL1_SW_SRC_BLEND_M0)) | (s_RGA2_ALPHA_CTRL1_SW_SRC_BLEND_M0(msg->alpha_mode_0 >> 1)));
    reg1 = ((reg1 & (~m_RGA2_ALPHA_CTRL1_SW_DST_ALPHA_M0)) | (s_RGA2_ALPHA_CTRL1_SW_DST_ALPHA_M0(msg->alpha_mode_0 >> RGA2_INDEX_EI)));
    reg1 = ((reg1 & (~m_RGA2_ALPHA_CTRL1_SW_SRC_ALPHA_M0)) | (s_RGA2_ALPHA_CTRL1_SW_SRC_ALPHA_M0(msg->alpha_mode_0 >> 0)));

    reg1 = ((reg1 & (~m_RGA2_ALPHA_CTRL1_SW_DST_FACTOR_M1)) | (s_RGA2_ALPHA_CTRL1_SW_DST_FACTOR_M1(msg->alpha_mode_1 >> RGA2_INDEX_TWE)));
    reg1 = ((reg1 & (~m_RGA2_ALPHA_CTRL1_SW_SRC_FACTOR_M1)) | (s_RGA2_ALPHA_CTRL1_SW_SRC_FACTOR_M1(msg->alpha_mode_1 >> RGA2_INDEX_FO)));
    reg1 = ((reg1 & (~m_RGA2_ALPHA_CTRL1_SW_DST_ALPHA_CAL_M1)) | (s_RGA2_ALPHA_CTRL1_SW_DST_ALPHA_CAL_M1(msg->alpha_mode_1 >> RGA2_INDEX_EIE)));
    reg1 = ((reg1 & (~m_RGA2_ALPHA_CTRL1_SW_SRC_ALPHA_CAL_M1)) | (s_RGA2_ALPHA_CTRL1_SW_SRC_ALPHA_CAL_M1(msg->alpha_mode_1 >> RGA2_INDEX_TH)));
    reg1 = ((reg1 & (~m_RGA2_ALPHA_CTRL1_SW_DST_BLEND_M1)) | (s_RGA2_ALPHA_CTRL1_SW_DST_BLEND_M1(msg->alpha_mode_1 >> RGA2_INDEX_NI)));
    reg1 = ((reg1 & (~m_RGA2_ALPHA_CTRL1_SW_SRC_BLEND_M1)) | (s_RGA2_ALPHA_CTRL1_SW_SRC_BLEND_M1(msg->alpha_mode_1 >> 1)));
    reg1 = ((reg1 & (~m_RGA2_ALPHA_CTRL1_SW_DST_ALPHA_M1)) | (s_RGA2_ALPHA_CTRL1_SW_DST_ALPHA_M1(msg->alpha_mode_1 >> RGA2_INDEX_EI)));
    ...
    *bRGA_ALPHA_CTRL1 = reg1;
    ...
    {
        *bRGA_FADING_CTRL = (1<<RGA2_INDEX_TWEF) | (msg->fading_b_value<<RGA2_INDEX_SIX) | (msg->fading_g_value<<RGA2_INDEX_EI) | (msg->fading_r_value);
    }
}
...
static void RGA2_set_reg_update_patten_buff(RK_U8 *base, struct rga2_req *msg)
{
    ...
    *bRGA_PAT_START_POINT = (pat->act_w * pat->y_offset) + pat->x_offset;
    ...
    reg = (pat->act_w-1) | ((pat->act_h-1) << RGA2_INDEX_EI) | (pat->x_offset << RGA2_INDEX_SIX) | (pat->y_offset << RGA2_INDEX_TWEF);
    *bRGA_PAT_CON = reg;
...
static void RGA2_set_mmu_info(RK_U8 *base, struct rga2_req *msg)
{
    ...
    reg = (msg->mmu_info.src0_mmu_flag & 0xf) | ((msg->mmu_info.src1_mmu_flag & 0xf) << RGA2_INDEX_FO)
         | ((msg->mmu_info.dst_mmu_flag & 0xf) << RGA2_INDEX_EI) | ((msg->mmu_info.els_mmu_flag & 0x3) << RGA2_INDEX_TWE);

    *bRGA_MMU_CTRL1 = reg;
    *bRGA_MMU_SRC_BASE  = (RK_U32)(msg->mmu_info.src0_base_addr) >> RGA2_INDEX_FO;
    *bRGA_MMU_SRC1_BASE = (RK_U32)(msg->mmu_info.src1_base_addr) >> RGA2_INDEX_FO;
    *bRGA_MMU_DST_BASE  = (RK_U32)(msg->mmu_info.dst_base_addr)  >> RGA2_INDEX_FO;
    *bRGA_MMU_ELS_BASE  = (RK_U32)(msg->mmu_info.els_base_addr)  >> RGA2_INDEX_FO;
}
...
void RGA_MSG_2_RGA2_MSG(struct rga_req *req_rga, struct rga2_req *req)
{
    ...
    req->alpha_rop_flag |= (((req_rga->alpha_rop_flag >> RGA2_INDEX_SI) & 1) << RGA2_INDEX_SE); // gradient fill mode sel
