...
static struct kbase_ipa_model_ops *kbase_ipa_model_ops_find(struct kbase_device *kbdev, const char *name)
{
    int i;
...
static u32 kbase_scale_dynamic_power(const u32 c, const u32 freq, const u32 voltage)
{
    ...
    return div_u64_rem(v2fc, 0x3E8, &remainder);
}
...
u32 kbase_scale_static_power(const u32 c, const u32 voltage)
{
    ...
    return div_u64_rem(v3c_big, 0xF4240, &remainder);
}
