...
} tl_stream_cfg[TL_STREAM_TYPE_COUNT] = {{TL_PACKET_FAMILY_TL, TL_PACKET_CLASS_OBJ, TL_PACKET_TYPE_HEADER, 1},
...
static ssize_t kbasep_tlstream_read(struct file *filp, char __user *buffer, size_t size, loff_t *f_pos);
...
static const struct tp_desc tp_desc_obj[] = {
    {KBASE_TL_NEW_CTX, __stringify(KBASE_TL_NEW_CTX), "object ctx is created", "@pII", "ctx,ctx_nr,tgid"},
    {KBASE_TL_NEW_GPU, __stringify(KBASE_TL_NEW_GPU), "object gpu is created", "@pII", "gpu,gpu_id,core_count"},
    {KBASE_TL_NEW_LPU, __stringify(KBASE_TL_NEW_LPU), "object lpu is created", "@pII", "lpu,lpu_nr,lpu_fn"},
    {KBASE_TL_NEW_ATOM, __stringify(KBASE_TL_NEW_ATOM), "object atom is created", "@pI", "atom,atom_nr"},
    {KBASE_TL_NEW_AS, __stringify(KBASE_TL_NEW_AS), "address space object is created", "@pI", "address_space,as_nr"},
    {KBASE_TL_DEL_CTX, __stringify(KBASE_TL_DEL_CTX), "context is destroyed", "@p", "ctx"},
    {KBASE_TL_DEL_ATOM, __stringify(KBASE_TL_DEL_ATOM), "atom is destroyed", "@p", "atom"},
    {KBASE_TL_LIFELINK_LPU_GPU, __stringify(KBASE_TL_LIFELINK_LPU_GPU), "lpu is deleted with gpu", "@pp", "lpu,gpu"},
    {KBASE_TL_LIFELINK_AS_GPU, __stringify(KBASE_TL_LIFELINK_AS_GPU), "address space is deleted with gpu", "@pp",
     "address_space,gpu"},
    {KBASE_TL_RET_CTX_LPU, __stringify(KBASE_TL_RET_CTX_LPU), "context is retained by lpu", "@pp", "ctx,lpu"},
    {KBASE_TL_RET_ATOM_CTX, __stringify(KBASE_TL_RET_ATOM_CTX), "atom is retained by context", "@pp", "atom,ctx"},
    {KBASE_TL_RET_ATOM_LPU, __stringify(KBASE_TL_RET_ATOM_LPU), "atom is retained by lpu", "@pps",
     "atom,lpu,attrib_match_list"},
    {KBASE_TL_NRET_CTX_LPU, __stringify(KBASE_TL_NRET_CTX_LPU), "context is released by lpu", "@pp", "ctx,lpu"},
    {KBASE_TL_NRET_ATOM_CTX, __stringify(KBASE_TL_NRET_ATOM_CTX), "atom is released by context", "@pp", "atom,ctx"},
    {KBASE_TL_NRET_ATOM_LPU, __stringify(KBASE_TL_NRET_ATOM_LPU), "atom is released by lpu", "@pp", "atom,lpu"},
    {KBASE_TL_RET_AS_CTX, __stringify(KBASE_TL_RET_AS_CTX), "address space is retained by context", "@pp",
     "address_space,ctx"},
    {KBASE_TL_NRET_AS_CTX, __stringify(KBASE_TL_NRET_AS_CTX), "address space is released by context", "@pp",
     "address_space,ctx"},
    {KBASE_TL_RET_ATOM_AS, __stringify(KBASE_TL_RET_ATOM_AS), "atom is retained by address space", "@pp",
     "atom,address_space"},
    {KBASE_TL_NRET_ATOM_AS, __stringify(KBASE_TL_NRET_ATOM_AS), "atom is released by address space", "@pp",
     "atom,address_space"},
    {KBASE_TL_DEP_ATOM_ATOM, __stringify(KBASE_TL_DEP_ATOM_ATOM), "atom2 depends on atom1", "@pp", "atom1,atom2"},
    {KBASE_TL_NDEP_ATOM_ATOM, __stringify(KBASE_TL_NDEP_ATOM_ATOM), "atom2 no longer depends on atom1", "@pp",
     "atom1,atom2"},
    {KBASE_TL_RDEP_ATOM_ATOM, __stringify(KBASE_TL_RDEP_ATOM_ATOM), "resolved dependecy of atom2 depending on atom1",
     "@pp", "atom1,atom2"},
    {KBASE_TL_ATTRIB_ATOM_CONFIG, __stringify(KBASE_TL_ATTRIB_ATOM_CONFIG), "atom job slot attributes", "@pLLI",
     "atom,descriptor,affinity,config"},
    {KBASE_TL_ATTRIB_ATOM_PRIORITY, __stringify(KBASE_TL_ATTRIB_ATOM_PRIORITY), "atom priority", "@pI", "atom,prio"},
    {KBASE_TL_ATTRIB_ATOM_STATE, __stringify(KBASE_TL_ATTRIB_ATOM_STATE), "atom state", "@pI", "atom,state"},
    {KBASE_TL_ATTRIB_ATOM_PRIORITY_CHANGE, __stringify(KBASE_TL_ATTRIB_ATOM_PRIORITY_CHANGE),
     "atom caused priority change", "@p", "atom"},
    {KBASE_TL_ATTRIB_ATOM_JIT, __stringify(KBASE_TL_ATTRIB_ATOM_JIT), "jit done for atom", "@pLL",
     "atom,edit_addr,new_addr"},
    {KBASE_TL_ATTRIB_AS_CONFIG, __stringify(KBASE_TL_ATTRIB_AS_CONFIG), "address space attributes", "@pLLL",
     "address_space,transtab,memattr,transcfg"},
    {KBASE_TL_EVENT_LPU_SOFTSTOP, __stringify(KBASE_TL_EVENT_LPU_SOFTSTOP), "softstop event on given lpu", "@p", "lpu"},
    {KBASE_TL_EVENT_ATOM_SOFTSTOP_EX, __stringify(KBASE_TL_EVENT_ATOM_SOFTSTOP_EX), "atom softstopped", "@p", "atom"},
    {KBASE_TL_EVENT_ATOM_SOFTSTOP_ISSUE, __stringify(KBASE_TL_EVENT_SOFTSTOP_ISSUE), "atom softstop issued", "@p",
     "atom"},
    {KBASE_JD_GPU_SOFT_RESET, __stringify(KBASE_JD_GPU_SOFT_RESET), "gpu soft reset", "@p", "gpu"},
};

/* Descriptors of timeline messages transmitted in auxiliary events stream. */
static const struct tp_desc tp_desc_aux[] = {
    {KBASE_AUX_PM_STATE, __stringify(KBASE_AUX_PM_STATE), "PM state", "@IL", "core_type,core_state_bitset"},
    {KBASE_AUX_PAGEFAULT, __stringify(KBASE_AUX_PAGEFAULT), "Page fault", "@IL", "ctx_nr,page_cnt_change"},
    {KBASE_AUX_PAGESALLOC, __stringify(KBASE_AUX_PAGESALLOC), "Total alloc pages change", "@IL", "ctx_nr,page_cnt"},
    {KBASE_AUX_DEVFREQ_TARGET, __stringify(KBASE_AUX_DEVFREQ_TARGET), "New device frequency target", "@L",
     "target_freq"},
    {KBASE_AUX_PROTECTED_ENTER_START, __stringify(KBASE_AUX_PROTECTED_ENTER_START), "enter protected mode start", "@p",
     "gpu"},
    {KBASE_AUX_PROTECTED_ENTER_END, __stringify(KBASE_AUX_PROTECTED_ENTER_END), "enter protected mode end", "@p",
     "gpu"},
    {KBASE_AUX_PROTECTED_LEAVE_START, __stringify(KBASE_AUX_PROTECTED_LEAVE_START), "leave protected mode start", "@p",
     "gpu"},
    {KBASE_AUX_PROTECTED_LEAVE_END, __stringify(KBASE_AUX_PROTECTED_LEAVE_END), "leave protected mode end", "@p",
     "gpu"}};
 ...
 */
static size_t kbasep_tlstream_write_bytes(char *buffer, size_t pos, const void *bytes, size_t len)
{
 ...
 * Return: updated position in the buffer
 */
static size_t kbasep_tlstream_write_string(char *buffer, size_t pos, const char *string, size_t max_write_size)
{
    u32 string_len;
    ...
    string_len = strlcpy(&buffer[pos + sizeof(string_len)], string, max_write_size);
...
static size_t kbasep_tlstream_write_timestamp(void *buffer, size_t pos)
{
    ...
    return kbasep_tlstream_write_bytes(buffer, pos, &timestamp, sizeof(timestamp));
}
 ...
 */
static void kbasep_tlstream_put_bits(u32 *word, u32 value, unsigned int bitpos, unsigned int bitlen)
{
 ...
 */
static void kbasep_tlstream_packet_header_setup(char *buffer, enum tl_packet_family pkt_family,
                                                ...
                                                unsigned int stream_id, int numbered)
{
    ...
    KBASE_DEBUG_ASSERT((pkt_type == TL_PACKET_TYPE_HEADER) || (pkt_type == TL_PACKET_TYPE_SUMMARY) ||
                       (pkt_type == TL_PACKET_TYPE_BODY));
    KBASE_DEBUG_ASSERT((pkt_class == TL_PACKET_CLASS_OBJ) || (pkt_class == TL_PACKET_CLASS_AUX));

    kbasep_tlstream_put_bits(&word0, pkt_family, PACKET_FAMILY_POS, PACKET_FAMILY_LEN);
    kbasep_tlstream_put_bits(&word0, pkt_class, PACKET_CLASS_POS, PACKET_CLASS_LEN);
    kbasep_tlstream_put_bits(&word0, pkt_type, PACKET_TYPE_POS, PACKET_TYPE_LEN);
    kbasep_tlstream_put_bits(&word0, stream_id, PACKET_STREAMID_POS, PACKET_STREAMID_LEN);

    if (numbered) {
        kbasep_tlstream_put_bits(&word1, 1, PACKET_SEQBIT_POS, PACKET_SEQBIT_LEN);
    }
 ...
 */
static void kbasep_tlstream_packet_header_update(char *buffer, size_t data_size)
{
    u32 word0;
    u32 word1;
    ...
    kbasep_tlstream_put_bits(&word1, data_size, PACKET_LENGTH_POS, PACKET_LENGTH_LEN);
...
static void kbasep_timeline_stream_reset(struct tl_stream *stream)
{
    ...
    for (i = 0; i < PACKET_COUNT; i++) {
        if (stream->numbered) {
            atomic_set(&stream->buffer[i].size, PACKET_HEADER_SIZE + PACKET_NUMBER_SIZE);
        } else {
 ...
 */
static void kbasep_timeline_stream_init(struct tl_stream *stream, enum tl_stream_type stream_type)
{
    unsigned int i;
    ...
    for (i = 0; i < PACKET_COUNT; i++) {
        kbasep_tlstream_packet_header_setup(stream->buffer[i].data, tl_stream_cfg[stream_type].pkt_family,
                                            tl_stream_cfg[stream_type].pkt_class, tl_stream_cfg[stream_type].pkt_type,
 ...
 */
static size_t kbasep_tlstream_msgbuf_submit(struct tl_stream *stream, unsigned int wb_idx_raw, unsigned int wb_size)
{
    ...
    kbasep_tlstream_packet_header_update(stream->buffer[wb_idx].data, wb_size - PACKET_HEADER_SIZE);

    if (stream->numbered) {
        kbasep_tlstream_packet_number_update(stream->buffer[wb_idx].data, wb_idx_raw);
    }
 ...
 */
static char *kbasep_tlstream_msgbuf_acquire(enum tl_stream_type stream_type, size_t msg_size, unsigned long *flags)
 ...
 */
static void kbasep_tlstream_msgbuf_release(enum tl_stream_type stream_type, unsigned long flags)
...
static void kbasep_tlstream_autoflush_timer_callback(struct timer_list *t)
{
    ...
    if (atomic_read(&autoflush_timer_active)) {
        rcode = mod_timer(&autoflush_timer, jiffies + msecs_to_jiffies(AUTOFLUSH_INTERVAL));
    }
    CSTD_UNUSED(rcode);
}
 ...
 */
static int kbasep_tlstream_packet_pending(enum tl_stream_type *stype, unsigned int *rb_idx_raw)
{
    int pending = 0;
...
static ssize_t kbasep_tlstream_read(struct file *filp, char __user *buffer, size_t size, loff_t *f_pos)
{
    ...
    while (copy_len < size) {
        ...
        if (0 < copy_len) {
            if (!kbasep_tlstream_packet_pending(&stype, &rb_idx_raw)) {
                break;
            }
        } else {
            if (wait_event_interruptible(tl_event_queue, kbasep_tlstream_packet_pending(&stype, &rb_idx_raw))) {
        ...
        if (copy_to_user(&buffer[copy_len], tl_stream[stype]->buffer[rb_idx].data, rb_size)) {
            copy_len = -EFAULT;
            break;
        }
 ...
 */
static void kbasep_tlstream_timeline_header(enum tl_stream_type stream_type, const struct tp_desc *tp_desc,
                                            u32 tp_count)
{
    ...
    for (i = 0; i < tp_count; i++) {
        ...
        msg_size += strnlen(tp_desc[i].id_str, STRLEN_MAX) + sizeof(char) + sizeof(u32);
        msg_size += strnlen(tp_desc[i].name, STRLEN_MAX) + sizeof(char) + sizeof(u32);
        msg_size += strnlen(tp_desc[i].arg_types, STRLEN_MAX) + sizeof(char) + sizeof(u32);
        msg_size += strnlen(tp_desc[i].arg_names, STRLEN_MAX) + sizeof(char) + sizeof(u32);
    }
    ...
    pos = kbasep_tlstream_write_bytes(buffer, pos, &tp_count, sizeof(tp_count));

    for (i = 0; i < tp_count; i++) {
        pos = kbasep_tlstream_write_bytes(buffer, pos, &tp_desc[i].id, sizeof(tp_desc[i].id));
        pos = kbasep_tlstream_write_string(buffer, pos, tp_desc[i].id_str, msg_size - pos);
        pos = kbasep_tlstream_write_string(buffer, pos, tp_desc[i].name, msg_size - pos);
        pos = kbasep_tlstream_write_string(buffer, pos, tp_desc[i].arg_types, msg_size - pos);
        pos = kbasep_tlstream_write_string(buffer, pos, tp_desc[i].arg_names, msg_size - pos);
    }
...
int kbase_tlstream_init(void)
{
    ...
    atomic_set(&autoflush_timer_active, 0);
    timer_setup(&autoflush_timer, kbasep_tlstream_autoflush_timer_callback, 0);
...
static void kbase_create_timeline_objects(struct kbase_context *kctx)
{
    ...
    KBASE_TLSTREAM_TL_SUMMARY_NEW_GPU(kbdev, kbdev->gpu_props.props.raw_props.gpu_id, kbdev->gpu_props.num_cores);
    ...
    for (as_nr = 0; as_nr < kbdev->nr_hw_address_spaces; as_nr++) {
        KBASE_TLSTREAM_TL_SUMMARY_LIFELINK_AS_GPU(&kbdev->as[as_nr], kbdev);
    }
    ...
    {
        KBASE_TLSTREAM_TL_SUMMARY_NEW_CTX(element->kctx, (u32)(element->kctx->id), (u32)(element->kctx->tgid));
    }
...
int kbase_tlstream_acquire(struct kbase_context *kctx, u32 flags)
{
    ...
    if (0 == atomic_cmpxchg(&kbase_tlstream_enabled, 0, tlstream_enabled)) {
        ...
        ret = anon_inode_getfd("[mali_tlstream]", &kbasep_tlstream_fops, kctx, O_RDONLY | O_CLOEXEC);
        if (ret < 0) {
            atomic_set(&kbase_tlstream_enabled, 0);
            return ret;
        }
        ...
        kbasep_timeline_stream_reset(tl_stream[TL_STREAM_TYPE_OBJ_HEADER]);
        kbasep_timeline_stream_reset(tl_stream[TL_STREAM_TYPE_OBJ_SUMMARY]);
        kbasep_timeline_stream_reset(tl_stream[TL_STREAM_TYPE_AUX_HEADER]);
        kbasep_tlstream_timeline_header(TL_STREAM_TYPE_OBJ_HEADER, tp_desc_obj, ARRAY_SIZE(tp_desc_obj));
        kbasep_tlstream_timeline_header(TL_STREAM_TYPE_AUX_HEADER, tp_desc_aux, ARRAY_SIZE(tp_desc_aux));
        ...
        if (flags & BASE_TLSTREAM_JOB_DUMPING_ENABLED) {
            dev_info(kctx->kbdev->dev, "Job dumping is enabled, readjusting the software event's timeout\n");
            atomic_set(&kctx->kbdev->js_data.soft_job_timeout_ms, 1800000);
        }
...
{
    kbasep_timeline_stream_reset(tl_stream[TL_STREAM_TYPE_OBJ]);
    kbasep_timeline_stream_reset(tl_stream[TL_STREAM_TYPE_AUX]);
}
...
void __kbase_tlstream_tl_summary_new_ctx(void *context, u32 nr, u32 tgid)
{
    ...
    const size_t msg_size = sizeof(msg_id) + sizeof(u64) + sizeof(context) + sizeof(nr) + sizeof(tgid);
    unsigned long flags;
    char *buffer;
    size_t pos = 0;

    buffer = kbasep_tlstream_msgbuf_acquire(TL_STREAM_TYPE_OBJ_SUMMARY, msg_size, &flags);
    KBASE_DEBUG_ASSERT(buffer);

    pos = kbasep_tlstream_write_bytes(buffer, pos, &msg_id, sizeof(msg_id));
    pos = kbasep_tlstream_write_timestamp(buffer, pos);
    pos = kbasep_tlstream_write_bytes(buffer, pos, &context, sizeof(context));
    pos = kbasep_tlstream_write_bytes(buffer, pos, &nr, sizeof(nr));
    pos = kbasep_tlstream_write_bytes(buffer, pos, &tgid, sizeof(tgid));
...
void __kbase_tlstream_tl_summary_new_gpu(void *gpu, u32 id, u32 core_count)
{
    ...
    const size_t msg_size = sizeof(msg_id) + sizeof(u64) + sizeof(gpu) + sizeof(id) + sizeof(core_count);
    unsigned long flags;
    char *buffer;
    size_t pos = 0;
    ...
    pos = kbasep_tlstream_write_bytes(buffer, pos, &msg_id, sizeof(msg_id));
    pos = kbasep_tlstream_write_timestamp(buffer, pos);
    pos = kbasep_tlstream_write_bytes(buffer, pos, &gpu, sizeof(gpu));
    pos = kbasep_tlstream_write_bytes(buffer, pos, &id, sizeof(id));
    pos = kbasep_tlstream_write_bytes(buffer, pos, &core_count, sizeof(core_count));
    KBASE_DEBUG_ASSERT(msg_size == pos);
...
void __kbase_tlstream_tl_summary_new_lpu(void *lpu, u32 nr, u32 fn)
{
    ...
    const size_t msg_size = sizeof(msg_id) + sizeof(u64) + sizeof(lpu) + sizeof(nr) + sizeof(fn);
    unsigned long flags;
    char *buffer;
    size_t pos = 0;
    ...
    pos = kbasep_tlstream_write_bytes(buffer, pos, &msg_id, sizeof(msg_id));
    pos = kbasep_tlstream_write_timestamp(buffer, pos);
    pos = kbasep_tlstream_write_bytes(buffer, pos, &lpu, sizeof(lpu));
    pos = kbasep_tlstream_write_bytes(buffer, pos, &nr, sizeof(nr));
    pos = kbasep_tlstream_write_bytes(buffer, pos, &fn, sizeof(fn));
    KBASE_DEBUG_ASSERT(msg_size == pos);
...
void __kbase_tlstream_tl_summary_lifelink_lpu_gpu(void *lpu, void *gpu)
{
    ...
    const size_t msg_size = sizeof(msg_id) + sizeof(u64) + sizeof(lpu) + sizeof(gpu);
    unsigned long flags;
    char *buffer;
    size_t pos = 0;
...
void __kbase_tlstream_tl_summary_new_as(void *as, u32 nr)
{
    ...
    const size_t msg_size = sizeof(msg_id) + sizeof(u64) + sizeof(as) + sizeof(nr);
    unsigned long flags;
    char *buffer;
    size_t pos = 0;
    ...
    pos = kbasep_tlstream_write_bytes(buffer, pos, &msg_id, sizeof(msg_id));
    pos = kbasep_tlstream_write_timestamp(buffer, pos);
    pos = kbasep_tlstream_write_bytes(buffer, pos, &as, sizeof(as));
    pos = kbasep_tlstream_write_bytes(buffer, pos, &nr, sizeof(nr));
    KBASE_DEBUG_ASSERT(msg_size == pos);
...
void __kbase_tlstream_tl_summary_lifelink_as_gpu(void *as, void *gpu)
{
    ...
    const size_t msg_size = sizeof(msg_id) + sizeof(u64) + sizeof(as) + sizeof(gpu);
    unsigned long flags;
    char *buffer;
    size_t pos = 0;
...
void __kbase_tlstream_tl_new_ctx(void *context, u32 nr, u32 tgid)
{
    ...
    buffer = kbasep_tlstream_msgbuf_acquire(TL_STREAM_TYPE_OBJ, msg_size, &flags);
    KBASE_DEBUG_ASSERT(buffer);
...
void __kbase_tlstream_tl_new_atom(void *atom, u32 nr)
{
    ...
    const size_t msg_size = sizeof(msg_id) + sizeof(u64) + sizeof(atom) + sizeof(nr);
    unsigned long flags;
    char *buffer;
    size_t pos = 0;
    ...
    pos = kbasep_tlstream_write_bytes(buffer, pos, &msg_id, sizeof(msg_id));
    pos = kbasep_tlstream_write_timestamp(buffer, pos);
    pos = kbasep_tlstream_write_bytes(buffer, pos, &atom, sizeof(atom));
    pos = kbasep_tlstream_write_bytes(buffer, pos, &nr, sizeof(nr));
    KBASE_DEBUG_ASSERT(msg_size == pos);
...
void __kbase_tlstream_tl_del_ctx(void *context)
{
    ...
    const size_t msg_size = sizeof(msg_id) + sizeof(u64) + sizeof(context);
    unsigned long flags;
    char *buffer;
    size_t pos = 0;
...
void __kbase_tlstream_tl_ret_ctx_lpu(void *context, void *lpu)
{
    ...
    const size_t msg_size = sizeof(msg_id) + sizeof(u64) + sizeof(context) + sizeof(lpu);
    unsigned long flags;
    char *buffer;
    size_t pos = 0;
...
void __kbase_tlstream_tl_ret_atom_ctx(void *atom, void *context)
{
    ...
    const size_t msg_size = sizeof(msg_id) + sizeof(u64) + sizeof(atom) + sizeof(context);
    unsigned long flags;
    char *buffer;
    size_t pos = 0;
...
void __kbase_tlstream_tl_ret_atom_lpu(void *atom, void *lpu, const char *attrib_match_list)
{
    ...
    const size_t msg_s0 = sizeof(u32) + sizeof(char) + strnlen(attrib_match_list, STRLEN_MAX);
    const size_t msg_size = sizeof(msg_id) + sizeof(u64) + sizeof(atom) + sizeof(lpu) + msg_s0;
    unsigned long flags;
    char *buffer;
    size_t pos = 0;
    ...
    pos = kbasep_tlstream_write_bytes(buffer, pos, &atom, sizeof(atom));
    pos = kbasep_tlstream_write_bytes(buffer, pos, &lpu, sizeof(lpu));
    pos = kbasep_tlstream_write_string(buffer, pos, attrib_match_list, msg_s0);
    KBASE_DEBUG_ASSERT(msg_size == pos);
...
void __kbase_tlstream_tl_dep_atom_atom(void *atom1, void *atom2)
{
    ...
    const size_t msg_size = sizeof(msg_id) + sizeof(u64) + sizeof(atom1) + sizeof(atom2);
    unsigned long flags;
    char *buffer;
    size_t pos = 0;
    ...
    pos = kbasep_tlstream_write_bytes(buffer, pos, &msg_id, sizeof(msg_id));
    pos = kbasep_tlstream_write_timestamp(buffer, pos);
    pos = kbasep_tlstream_write_bytes(buffer, pos, &atom1, sizeof(atom1));
    pos = kbasep_tlstream_write_bytes(buffer, pos, &atom2, sizeof(atom2));
    KBASE_DEBUG_ASSERT(msg_size == pos);
...
void __kbase_tlstream_tl_nret_atom_lpu(void *atom, void *lpu)
{
    ...
    const size_t msg_size = sizeof(msg_id) + sizeof(u64) + sizeof(atom) + sizeof(lpu);
    unsigned long flags;
    char *buffer;
    size_t pos = 0;
...
void __kbase_tlstream_tl_ret_as_ctx(void *as, void *ctx)
{
    ...
    const size_t msg_size = sizeof(msg_id) + sizeof(u64) + sizeof(as) + sizeof(ctx);
    unsigned long flags;
    char *buffer;
    size_t pos = 0;
    ...
    pos = kbasep_tlstream_write_timestamp(buffer, pos);
    pos = kbasep_tlstream_write_bytes(buffer, pos, &as, sizeof(as));
    pos = kbasep_tlstream_write_bytes(buffer, pos, &ctx, sizeof(ctx));
    KBASE_DEBUG_ASSERT(msg_size == pos);
...
void __kbase_tlstream_tl_ret_atom_as(void *atom, void *as)
{
    ...
    const size_t msg_size = sizeof(msg_id) + sizeof(u64) + sizeof(atom) + sizeof(as);
    unsigned long flags;
    char *buffer;
    size_t pos = 0;
...
void __kbase_tlstream_tl_attrib_atom_config(void *atom, u64 jd, u64 affinity, u32 config)
{
    ...
    const size_t msg_size =
        sizeof(msg_id) + sizeof(u64) + sizeof(atom) + sizeof(jd) + sizeof(affinity) + sizeof(config);
    unsigned long flags;
    char *buffer;
    size_t pos = 0;
    ...
    pos = kbasep_tlstream_write_timestamp(buffer, pos);
    pos = kbasep_tlstream_write_bytes(buffer, pos, &atom, sizeof(atom));
    pos = kbasep_tlstream_write_bytes(buffer, pos, &jd, sizeof(jd));
    pos = kbasep_tlstream_write_bytes(buffer, pos, &affinity, sizeof(affinity));
    pos = kbasep_tlstream_write_bytes(buffer, pos, &config, sizeof(config));
    KBASE_DEBUG_ASSERT(msg_size == pos);
...
void __kbase_tlstream_tl_attrib_atom_priority(void *atom, u32 prio)
{
    ...
    const size_t msg_size = sizeof(msg_id) + sizeof(u64) + sizeof(atom) + sizeof(prio);
    unsigned long flags;
    char *buffer;
    size_t pos = 0;
    ...
    pos = kbasep_tlstream_write_timestamp(buffer, pos);
    pos = kbasep_tlstream_write_bytes(buffer, pos, &atom, sizeof(atom));
    pos = kbasep_tlstream_write_bytes(buffer, pos, &prio, sizeof(prio));
    KBASE_DEBUG_ASSERT(msg_size == pos);
...
void __kbase_tlstream_tl_attrib_atom_state(void *atom, u32 state)
{
    ...
    const size_t msg_size = sizeof(msg_id) + sizeof(u64) + sizeof(atom) + sizeof(state);
    unsigned long flags;
    char *buffer;
    size_t pos = 0;
...
void __kbase_tlstream_tl_attrib_atom_jit(void *atom, u64 edit_addr, u64 new_addr)
{
    ...
    const size_t msg_size = sizeof(msg_id) + sizeof(u64) + sizeof(atom) + sizeof(edit_addr) + sizeof(new_addr);
    unsigned long flags;
    char *buffer;
    size_t pos = 0;
    ...
    pos = kbasep_tlstream_write_timestamp(buffer, pos);
    pos = kbasep_tlstream_write_bytes(buffer, pos, &atom, sizeof(atom));
    pos = kbasep_tlstream_write_bytes(buffer, pos, &edit_addr, sizeof(edit_addr));
    pos = kbasep_tlstream_write_bytes(buffer, pos, &new_addr, sizeof(new_addr));
    KBASE_DEBUG_ASSERT(msg_size == pos);
...
void __kbase_tlstream_tl_attrib_as_config(void *as, u64 transtab, u64 memattr, u64 transcfg)
{
    ...
    const size_t msg_size =
        sizeof(msg_id) + sizeof(u64) + sizeof(as) + sizeof(transtab) + sizeof(memattr) + sizeof(transcfg);
    unsigned long flags;
    char *buffer;
    size_t pos = 0;
    ...
    pos = kbasep_tlstream_write_timestamp(buffer, pos);
    pos = kbasep_tlstream_write_bytes(buffer, pos, &as, sizeof(as));
    pos = kbasep_tlstream_write_bytes(buffer, pos, &transtab, sizeof(transtab));
    pos = kbasep_tlstream_write_bytes(buffer, pos, &memattr, sizeof(memattr));
    pos = kbasep_tlstream_write_bytes(buffer, pos, &transcfg, sizeof(transcfg));
    KBASE_DEBUG_ASSERT(msg_size == pos);
...
void __kbase_tlstream_tl_event_lpu_softstop(void *lpu)
{
    ...
    const size_t msg_size = sizeof(msg_id) + sizeof(u64) + sizeof(lpu);
    unsigned long flags;
    char *buffer;
    size_t pos = 0;
...
void __kbase_tlstream_aux_pm_state(u32 core_type, u64 state)
{
    ...
    const size_t msg_size = sizeof(msg_id) + sizeof(u64) + sizeof(core_type) + sizeof(state);
    unsigned long flags;
    char *buffer;
    size_t pos = 0;

    buffer = kbasep_tlstream_msgbuf_acquire(TL_STREAM_TYPE_AUX, msg_size, &flags);
    KBASE_DEBUG_ASSERT(buffer);

    pos = kbasep_tlstream_write_bytes(buffer, pos, &msg_id, sizeof(msg_id));
    pos = kbasep_tlstream_write_timestamp(buffer, pos);
    pos = kbasep_tlstream_write_bytes(buffer, pos, &core_type, sizeof(core_type));
    pos = kbasep_tlstream_write_bytes(buffer, pos, &state, sizeof(state));
    KBASE_DEBUG_ASSERT(msg_size == pos);
...
void __kbase_tlstream_aux_pagefault(u32 ctx_nr, u64 page_count_change)
{
    ...
    const size_t msg_size = sizeof(msg_id) + sizeof(u64) + sizeof(ctx_nr) + sizeof(page_count_change);
    unsigned long flags;
    char *buffer;
    size_t pos = 0;
    ...
    pos = kbasep_tlstream_write_bytes(buffer, pos, &page_count_change, sizeof(page_count_change));
    KBASE_DEBUG_ASSERT(msg_size == pos);
...
void __kbase_tlstream_aux_pagesalloc(u32 ctx_nr, u64 page_count)
{
    ...
    const size_t msg_size = sizeof(msg_id) + sizeof(u64) + sizeof(ctx_nr) + sizeof(page_count);
    unsigned long flags;
    char *buffer;
    size_t pos = 0;
    ...
    pos = kbasep_tlstream_write_timestamp(buffer, pos);
    pos = kbasep_tlstream_write_bytes(buffer, pos, &ctx_nr, sizeof(ctx_nr));
    pos = kbasep_tlstream_write_bytes(buffer, pos, &page_count, sizeof(page_count));
    KBASE_DEBUG_ASSERT(msg_size == pos);
...
void __kbase_tlstream_aux_devfreq_target(u64 target_freq)
{
    ...
    const size_t msg_size = sizeof(msg_id) + sizeof(u64) + sizeof(target_freq);
    unsigned long flags;
    char *buffer;
    size_t pos = 0;
    ...
    pos = kbasep_tlstream_write_bytes(buffer, pos, &msg_id, sizeof(msg_id));
    pos = kbasep_tlstream_write_timestamp(buffer, pos);
    pos = kbasep_tlstream_write_bytes(buffer, pos, &target_freq, sizeof(target_freq));
    KBASE_DEBUG_ASSERT(msg_size == pos);
