...
#define MALI400PP_REG_VAL_CTRL_SHIFT 16
#define MALI400PP_REG_VAL_CTRL_MASK 0xFFFFFFF8
...
#define MALI200_REG_VAL_IRQ_MASK_ALL                                                                                   \
    ((enum mali200_mgmt_irq)(                                                                                          \
        MALI200_REG_VAL_IRQ_END_OF_FRAME | MALI200_REG_VAL_IRQ_END_OF_TILE | MALI200_REG_VAL_IRQ_HANG |                \
        MALI200_REG_VAL_IRQ_FORCE_HANG | MALI200_REG_VAL_IRQ_BUS_ERROR | MALI200_REG_VAL_IRQ_BUS_STOP |                \
        MALI200_REG_VAL_IRQ_CNT_0_LIMIT | MALI200_REG_VAL_IRQ_CNT_1_LIMIT | MALI200_REG_VAL_IRQ_WRITE_BOUNDARY_ERROR | \
        MALI400PP_REG_VAL_IRQ_INVALID_PLIST_COMMAND | MALI400PP_REG_VAL_IRQ_CALL_STACK_UNDERFLOW |                     \
        MALI400PP_REG_VAL_IRQ_CALL_STACK_OVERFLOW | MALI400PP_REG_VAL_IRQ_RESET_COMPLETED))

#define MALI200_REG_VAL_IRQ_MASK_USED                                                                                  \
    ((enum mali200_mgmt_irq)(MALI200_REG_VAL_IRQ_END_OF_FRAME | MALI200_REG_VAL_IRQ_FORCE_HANG |                       \
                             MALI200_REG_VAL_IRQ_BUS_ERROR | MALI200_REG_VAL_IRQ_WRITE_BOUNDARY_ERROR |                \
                             MALI400PP_REG_VAL_IRQ_INVALID_PLIST_COMMAND |                                             \
                             MALI400PP_REG_VAL_IRQ_CALL_STACK_UNDERFLOW | MALI400PP_REG_VAL_IRQ_CALL_STACK_OVERFLOW))
...
enum mali200_wb_unit { MALI200_REG_ADDR_WB0 = 0x0100, MALI200_REG_ADDR_WB1 = 0x0200, MALI200_REG_ADDR_WB2 = 0x0300 };
