...
#ifndef MALIGP2_CONROL_REGS_H_
#define MALIGP2_CONROL_REGS_H_
...
#define MALIGP2_REG_VAL_IRQ_MASK_ALL                                                                                   \
    (MALIGP2_REG_VAL_IRQ_VS_END_CMD_LST | MALIGP2_REG_VAL_IRQ_PLBU_END_CMD_LST | MALIGP2_REG_VAL_IRQ_PLBU_OUT_OF_MEM | \
     MALIGP2_REG_VAL_IRQ_VS_SEM_IRQ | MALIGP2_REG_VAL_IRQ_PLBU_SEM_IRQ | MALIGP2_REG_VAL_IRQ_HANG |                    \
     MALIGP2_REG_VAL_IRQ_FORCE_HANG | MALIGP2_REG_VAL_IRQ_PERF_CNT_0_LIMIT | MALIGP2_REG_VAL_IRQ_PERF_CNT_1_LIMIT |    \
     MALIGP2_REG_VAL_IRQ_WRITE_BOUND_ERR | MALIGP2_REG_VAL_IRQ_SYNC_ERROR | MALIGP2_REG_VAL_IRQ_AXI_BUS_ERROR |        \
     MALI400GP_REG_VAL_IRQ_AXI_BUS_STOPPED | MALI400GP_REG_VAL_IRQ_VS_INVALID_CMD |                                    \
     MALI400GP_REG_VAL_IRQ_PLB_INVALID_CMD | MALI400GP_REG_VAL_IRQ_RESET_COMPLETED |                                   \
     MALI400GP_REG_VAL_IRQ_SEMAPHORE_UNDERFLOW | MALI400GP_REG_VAL_IRQ_SEMAPHORE_OVERFLOW |                            \
...
#define MALIGP2_REG_VAL_IRQ_MASK_USED                                                                                  \
    (MALIGP2_REG_VAL_IRQ_VS_END_CMD_LST | MALIGP2_REG_VAL_IRQ_PLBU_END_CMD_LST | MALIGP2_REG_VAL_IRQ_PLBU_OUT_OF_MEM | \
     MALIGP2_REG_VAL_IRQ_FORCE_HANG | MALIGP2_REG_VAL_IRQ_WRITE_BOUND_ERR | MALIGP2_REG_VAL_IRQ_SYNC_ERROR |           \
     MALIGP2_REG_VAL_IRQ_AXI_BUS_ERROR | MALI400GP_REG_VAL_IRQ_VS_INVALID_CMD |                                        \
...
#define MALIGP2_REG_VAL_STATUS_MASK_ACTIVE (MALIGP2_REG_VAL_STATUS_VS_ACTIVE | MALIGP2_REG_VAL_STATUS_PLBU_ACTIVE)
