...
{
    mali_uk_get_api_version_s kargs;
...
{
    mali_uk_get_api_version_v2_s kargs;
    mali_osk_errcode_t err;
...
{
    mali_uk_wait_for_notification_s kargs;
    mali_osk_errcode_t err;
...
{
    mali_uk_post_notification_s kargs;
    mali_osk_errcode_t err;
...
{
    mali_uk_get_user_settings_s kargs;
    mali_osk_errcode_t err;
...
{
    mali_uk_request_high_priority_s kargs;
    mali_osk_errcode_t err;
...
{
    mali_uk_pending_submit_s kargs;
    mali_osk_errcode_t err;
