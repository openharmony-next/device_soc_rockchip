 ...
 *
 * This program is free software and is
 * provided to you under the terms of the GNU General Public License version 2
 * as published by the Free Software
 * Foundation, and any use by you of this program is subject to the terms of such GNU licence.
 *
 * A copy of the
 * licence is included with the program, and can also be obtained from Free Software
