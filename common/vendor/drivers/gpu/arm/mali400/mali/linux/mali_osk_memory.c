...
void inline *mali_osk_calloc(u32 n, u32 size)
{
    return kcalloc(n, size, GFP_KERNEL);
}

void inline *mali_osk_malloc(u32 size)
{
...
void inline *mali_osk_memcpy(void *dst, const void *src, u32  len)
{
    return memcpy(dst, src, len);
}

void inline *mali_osk_memset(void *s, u32 c, u32 n)
{
    return memset(s, c, n);
}
