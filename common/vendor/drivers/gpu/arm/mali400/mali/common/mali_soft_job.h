 ...
 *
 * @return MALI_OSK_ERR_ITEM_NOT_FOUND if the soft job ID was invalid, MALI_OSK_ERR_TIMEOUT if the
 * soft job was timed out or MALI_OSK_ERR_OK if we successfully signaled the soft job.
 */
