...
#define MALI_IOC_WAIT_FOR_NOTIFICATION      _IOWR(MALI_IOC_CORE_BASE, MALI_UK_WAIT_FOR_NOTIFICATION, mali_uk_wait_for_notification_s)
...
#define MALI_IOC_REQUEST_HIGH_PRIORITY      _IOW (MALI_IOC_CORE_BASE, MALI_UK_REQUEST_HIGH_PRIORITY, mali_uk_request_high_priority_s)
#define MALI_IOC_TIMELINE_GET_LATEST_POINT  _IOWR(MALI_IOC_CORE_BASE, MALI_UK_TIMELINE_GET_LATEST_POINT, mali_uk_timeline_get_latest_point_s)
#define MALI_IOC_TIMELINE_WAIT              _IOWR(MALI_IOC_CORE_BASE, MALI_UK_TIMELINE_WAIT, mali_uk_timeline_wait_s)
#define MALI_IOC_TIMELINE_CREATE_SYNC_FENCE _IOWR(MALI_IOC_CORE_BASE, MALI_UK_TIMELINE_CREATE_SYNC_FENCE, mali_uk_timeline_create_sync_fence_s)
...
#define MALI_IOC_MEM_QUERY_MMU_PAGE_TABLE_DUMP_SIZE _IOR (MALI_IOC_MEMORY_BASE, MALI_UK_QUERY_MMU_PAGE_TABLE_DUMP_SIZE, mali_uk_query_mmu_page_table_dump_size_s)
#define MALI_IOC_MEM_DUMP_MMU_PAGE_TABLE    _IOWR(MALI_IOC_MEMORY_BASE, MALI_UK_DUMP_MMU_PAGE_TABLE, mali_uk_dump_mmu_page_table_s)
...
#define MALI_IOC_PP_NUMBER_OF_CORES_GET     _IOR (MALI_IOC_PP_BASE, MALI_UK_GET_PP_NUMBER_OF_CORES, mali_uk_get_pp_number_of_cores_s)
...
#define MALI_IOC_GP2_NUMBER_OF_CORES_GET    _IOR (MALI_IOC_GP_BASE, MALI_UK_GET_GP_NUMBER_OF_CORES, mali_uk_get_gp_number_of_cores_s)
...
#define MALI_IOC_PROFILING_ADD_EVENT        _IOWR(MALI_IOC_PROFILING_BASE, MALI_UK_PROFILING_ADD_EVENT, mali_uk_profiling_add_event_s)
#define MALI_IOC_PROFILING_REPORT_SW_COUNTERS  _IOW (MALI_IOC_PROFILING_BASE, MALI_UK_PROFILING_REPORT_SW_COUNTERS, mali_uk_sw_counters_report_s)
#define MALI_IOC_PROFILING_MEMORY_USAGE_GET _IOR(MALI_IOC_PROFILING_BASE, MALI_UK_PROFILING_MEMORY_USAGE_GET, mali_uk_profiling_memory_usage_get_s)
#define MALI_IOC_PROFILING_STREAM_FD_GET        _IOR(MALI_IOC_PROFILING_BASE, MALI_UK_PROFILING_STREAM_FD_GET, mali_uk_profiling_stream_fd_get_s)
#define MALI_IOC_PROILING_CONTROL_SET   _IOR(MALI_IOC_PROFILING_BASE, MALI_UK_PROFILING_CONTROL_SET, mali_uk_profiling_control_set_s)
