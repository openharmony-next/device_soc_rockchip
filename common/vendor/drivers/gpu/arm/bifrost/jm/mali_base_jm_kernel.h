 ...
 */
#define BASE_MEM_FLAGS_NR_HI_BITS 32
#define BASE_MEM_FLAGS_MAX        0xFFFFFFFF
#define KBASE_INSTR_STATE_USE     24
#define KBASE_RENDERPASS_ID_SIZE  8
#define KBASE_BASE_MEM_PROTECTED  16
