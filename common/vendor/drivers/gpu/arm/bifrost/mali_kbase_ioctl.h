...
#define KBASE_IOCTL_MEM_JIT_INIT_10_2 _IOW(KBASE_IOCTL_TYPE, 14, struct kbase_ioctl_mem_jit_init_10_2)
...
#define KBASE_IOCTL_MEM_JIT_INIT_11_5 _IOW(KBASE_IOCTL_TYPE, 14, struct kbase_ioctl_mem_jit_init_11_5)
...
#define KBASE_IOCTL_STICKY_RESOURCE_MAP _IOW(KBASE_IOCTL_TYPE, 29, struct kbase_ioctl_sticky_resource_map)
...
#define KBASE_IOCTL_STICKY_RESOURCE_UNMAP _IOW(KBASE_IOCTL_TYPE, 30, struct kbase_ioctl_sticky_resource_unmap)
...
#define KBASE_IOCTL_GET_CPU_GPU_TIMEINFO _IOWR(KBASE_IOCTL_TYPE, 50, union kbase_ioctl_get_cpu_gpu_timeinfo)
