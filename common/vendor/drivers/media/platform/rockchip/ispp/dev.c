...
#define RKISPP_NODE_INDEX 2
#define RKISPP_NODE_OFFSET_THI 16
#define RKISPP_NODE_OFFSET_EI 8
#define RKISPP_NODE_OFFSET_FI 5
...
static int rkispp_plat_probe(struct platform_device *pdev)
{
    ...
    v4l2_ctrl_handler_init(&ispp_dev->ctrl_handler, RKISPP_NODE_OFFSET_FI);
