           ...
           const struct isp21_cnr_cfg *arg)
{
    ...
    value = (arg->sw_cnr_hbf5_weit_src & 0xFF) << CIF_ISP_EXP_OFFSET_TWF |
        (arg->sw_cnr_hbf5_min_wgt & 0xFF) << CIF_ISP_EXP_OFFSET_THI |
         ...
         const struct isp21_sharp_cfg *arg)
{
    ...
    value = (arg->sw_sharp_luma_dx[CIF_IMG_EFF_CTRL_MODE_SHARPEN_SHIFT] & 0x0F) << CIF_ISP_EXP_OFFSET_TWF |
        ...
        (arg->sw_sharp_luma_dx[1] & 0x0F) << CIF_IMG_EFF_CTRL_MODE_EMBOSS_SHIFT |
    ...
    value = (arg->sw_sharp_bf_sigma_inv[CIF_IMG_EFF_CTRL_MODE_SEPIA_SHIFT] & 0x3FF) << CIF_ISP_EXP_OFFSET_TW |
        (arg->sw_sharp_bf_sigma_inv[1] & 0x3FF) << CIF_ISP_EXP_OFFSET_TEN |
    ...
    value = (arg->sw_sharp_ehf_th[CIF_IMG_EFF_CTRL_MODE_SEPIA_SHIFT] & 0x3FF) << CIF_ISP_EXP_OFFSET_TW |
        (arg->sw_sharp_ehf_th[1] & 0x3FF) << CIF_ISP_EXP_OFFSET_TEN |
    ...
    value = (arg->sw_sharp_clip_hf[CIF_IMG_EFF_CTRL_MODE_SEPIA_SHIFT] & 0x3FF) << CIF_ISP_EXP_OFFSET_TW |
        (arg->sw_sharp_clip_hf[1] & 0x3FF) << CIF_ISP_EXP_OFFSET_TEN |
         ...
         const struct isp21_baynr_cfg *arg)
{
    ...
    value |= (arg->sw_baynr_gauss_en & 0x1) << CIF_DUAL_CROP_SP_MODE_RAW |
         (arg->sw_baynr_log_bypass & 0x1) << CIF_IMG_EFF_CTRL_MODE_EMBOSS_SHIFT;
    ...
    for (i = 0; i < ISP21_BAYNR_XY_NUM / CIF_IMG_EFF_CTRL_MODE_SEPIA_SHIFT; i++) {
        value = ISP2X_PACK_2SHORT(arg->sw_sigma_x[CIF_IMG_EFF_CTRL_MODE_SEPIA_SHIFT * i], arg->sw_sigma_x[CIF_IMG_EFF_CTRL_MODE_SEPIA_SHIFT * i + 1]);
        rkisp_iowrite32(params_vdev, value, ISP21_BAYNR_SIGMAX01 + CIF_IMG_EFF_CTRL_MODE_EMBOSS_SHIFT * i);
    }

    for (i = 0; i < ISP21_BAYNR_XY_NUM / CIF_IMG_EFF_CTRL_MODE_SEPIA_SHIFT; i++) {
        value = ISP2X_PACK_2SHORT(arg->sw_sigma_y[CIF_IMG_EFF_CTRL_MODE_SEPIA_SHIFT * i], arg->sw_sigma_y[CIF_IMG_EFF_CTRL_MODE_SEPIA_SHIFT * i + 1]);
        rkisp_iowrite32(params_vdev, value, ISP21_BAYNR_SIGMAY01 + CIF_IMG_EFF_CTRL_MODE_EMBOSS_SHIFT * i);
    }

    value = (arg->weit_d2 & 0x3FF) << CIF_ISP_EXP_OFFSET_TW |
        (arg->weit_d1 & 0x3FF) << CIF_ISP_EXP_OFFSET_TEN |
        (arg->weit_d0 & 0x3FF);
    ...
    for (i = 0; i < ISP21_CSM_COEFF_NUM; i++) {
        if (i == 0)
            val = (arg->csm_y_offset & 0x3f) << CIF_ISP_EXP_OFFSET_TWF |
                  (arg->csm_c_offset & 0xff) << CIF_ISP_EXP_OFFSET_THI |
...
static MAYBE_UNUSED
void _isp_isr_other_config(struct rkisp_isp_params_vdev *params_vdev,
...
static MAYBE_UNUSED
void _isp_isr_other_en(struct rkisp_isp_params_vdev *params_vdev,
            const struct isp21_isp_params_cfg *new_params,
            enum rkisp_params_type type)
{
    struct rkisp_isp_params_v21_ops *ops =
...
static MAYBE_UNUSED
void _isp_isr_meas_config(struct rkisp_isp_params_vdev *params_vdev,
...
static MAYBE_UNUSED
void _isp_isr_meas_en(struct rkisp_isp_params_vdev *params_vdev,
               struct isp21_isp_params_cfg *new_params,
               enum rkisp_params_type type)
{
    struct rkisp_isp_params_v21_ops *ops =
...
static MAYBE_UNUSED
void _isp_config_hdrshd(struct rkisp_isp_params_vdev *params_vdev)
{
    struct rkisp_isp_params_v21_ops *ops =
        (struct rkisp_isp_params_v21_ops *)params_vdev->priv_ops;
    struct rkisp_isp_params_val_v21 *priv_val =
