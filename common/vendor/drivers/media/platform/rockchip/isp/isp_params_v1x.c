...
#define BLS_FIX_SUB_IS_VALID(val) ((val) > (s16)CIFISP_BLS_FIX_SUB_MIN && (val) < CIFISP_BLS_FIX_SUB_MAX)
...
static inline void rkisp1_iowrite32(struct rkisp_isp_params_vdev *params_vdev, u32 value, u32 addr)
{
    iowrite32(value, params_vdev->dev->base_addr + addr);
}

static inline u32 rkisp1_ioread32(struct rkisp_isp_params_vdev *params_vdev, u32 addr)
{
    return ioread32(params_vdev->dev->base_addr + addr);
}

/* ISP BP interface function */
static void isp_dpcc_config(struct rkisp_isp_params_vdev *params_vdev, const struct cifisp_dpcc_config *arg)
{
    unsigned int i;
    u32 mode;
    ...
    for (i = 0; i < CIFISP_DPCC_METHODS_MAX; i++) {
        ...
        rkisp1_iowrite32(params_vdev, arg->methods[i].pg_fac, RKISP1_ISP_DPCC_PG_FAC(i));
        rkisp1_iowrite32(params_vdev, arg->methods[i].rnd_thresh, RKISP1_ISP_DPCC_RND_THRESH(i));
        rkisp1_iowrite32(params_vdev, arg->methods[i].rg_fac, RKISP1_ISP_DPCC_RG_FAC(i));
    }
...
static void isp_bls_config(struct rkisp_isp_params_vdev *params_vdev, const struct cifisp_bls_config *arg)
{
    /* avoid to override the old enable value */
    u32 new_control;
    ...
    if (!arg->enable_auto) {
        ...
        switch (params_vdev->raw_type) {
            case RAW_BGGR:
                rkisp1_iowrite32(params_vdev, pval->r, CIF_ISP_BLS_D_FIXED);
                rkisp1_iowrite32(params_vdev, pval->gr, CIF_ISP_BLS_C_FIXED);
                rkisp1_iowrite32(params_vdev, pval->gb, CIF_ISP_BLS_B_FIXED);
                rkisp1_iowrite32(params_vdev, pval->b, CIF_ISP_BLS_A_FIXED);
                break;
            case RAW_GBRG:
                rkisp1_iowrite32(params_vdev, pval->r, CIF_ISP_BLS_C_FIXED);
                rkisp1_iowrite32(params_vdev, pval->gr, CIF_ISP_BLS_D_FIXED);
                rkisp1_iowrite32(params_vdev, pval->gb, CIF_ISP_BLS_A_FIXED);
                rkisp1_iowrite32(params_vdev, pval->b, CIF_ISP_BLS_B_FIXED);
                break;
            case RAW_GRBG:
                rkisp1_iowrite32(params_vdev, pval->r, CIF_ISP_BLS_B_FIXED);
                rkisp1_iowrite32(params_vdev, pval->gr, CIF_ISP_BLS_A_FIXED);
                rkisp1_iowrite32(params_vdev, pval->gb, CIF_ISP_BLS_D_FIXED);
                rkisp1_iowrite32(params_vdev, pval->b, CIF_ISP_BLS_C_FIXED);
                break;
            case RAW_RGGB:
                rkisp1_iowrite32(params_vdev, pval->r, CIF_ISP_BLS_A_FIXED);
                rkisp1_iowrite32(params_vdev, pval->gr, CIF_ISP_BLS_B_FIXED);
                rkisp1_iowrite32(params_vdev, pval->gb, CIF_ISP_BLS_C_FIXED);
                rkisp1_iowrite32(params_vdev, pval->b, CIF_ISP_BLS_D_FIXED);
                break;
            default:
                break;
        }
        ...
        if (arg->en_windows & BIT(1)) {
            ...
            rkisp1_iowrite32(params_vdev, arg->bls_window2.h_size, CIF_ISP_BLS_H2_STOP);
            rkisp1_iowrite32(params_vdev, arg->bls_window2.v_offs, CIF_ISP_BLS_V2_START);
            rkisp1_iowrite32(params_vdev, arg->bls_window2.v_size, CIF_ISP_BLS_V2_STOP);
            new_control |= CIF_ISP_BLS_WINDOW_2;
        }

        if (arg->en_windows & BIT(0)) {
            rkisp1_iowrite32(params_vdev, arg->bls_window1.h_offs, CIF_ISP_BLS_H1_START);
            rkisp1_iowrite32(params_vdev, arg->bls_window1.h_size, CIF_ISP_BLS_H1_STOP);
            rkisp1_iowrite32(params_vdev, arg->bls_window1.v_offs, CIF_ISP_BLS_V1_START);
            rkisp1_iowrite32(params_vdev, arg->bls_window1.v_size, CIF_ISP_BLS_V1_STOP);
            new_control |= CIF_ISP_BLS_WINDOW_1;
        }

        rkisp1_iowrite32(params_vdev, arg->bls_samples, CIF_ISP_BLS_SAMPLES);
...
static void isp_lsc_matrix_config_v10(struct rkisp_isp_params_vdev *params_vdev,
                                      const struct cifisp_lsc_config *pconfig)
{
    ...
    sram_addr =
        (isp_lsc_status & CIF_ISP_LSC_ACTIVE_TABLE) ? CIF_ISP_LSC_TABLE_ADDRESS_0 : CIF_ISP_LSC_TABLE_ADDRESS_153;
    ...
    for (i = 0; i < CIF_ISP_LSC_SECTORS_MAX * CIF_ISP_LSC_SECTORS_MAX; i += CIF_ISP_LSC_SECTORS_MAX) {
        ...
        for (j = 0; j < CIF_ISP_LSC_SECTORS_MAX - 1; j += 0x02) {
            ...
            data = CIF_ISP_LSC_TABLE_DATA_V10(pconfig->gr_data_tbl[i + j], pconfig->gr_data_tbl[i + j + 1]);
            rkisp1_iowrite32(params_vdev, data, CIF_ISP_LSC_GR_TABLE_DATA);

            data = CIF_ISP_LSC_TABLE_DATA_V10(pconfig->gb_data_tbl[i + j], pconfig->gb_data_tbl[i + j + 1]);
            rkisp1_iowrite32(params_vdev, data, CIF_ISP_LSC_GB_TABLE_DATA);

            data = CIF_ISP_LSC_TABLE_DATA_V10(pconfig->b_data_tbl[i + j], pconfig->b_data_tbl[i + j + 1]);
            rkisp1_iowrite32(params_vdev, data, CIF_ISP_LSC_B_TABLE_DATA);
        }

        data = CIF_ISP_LSC_TABLE_DATA_V10(pconfig->r_data_tbl[i + j], 0);
        rkisp1_iowrite32(params_vdev, data, CIF_ISP_LSC_R_TABLE_DATA);

        data = CIF_ISP_LSC_TABLE_DATA_V10(pconfig->gr_data_tbl[i + j], 0);
        rkisp1_iowrite32(params_vdev, data, CIF_ISP_LSC_GR_TABLE_DATA);

        data = CIF_ISP_LSC_TABLE_DATA_V10(pconfig->gb_data_tbl[i + j], 0);
        rkisp1_iowrite32(params_vdev, data, CIF_ISP_LSC_GB_TABLE_DATA);

        data = CIF_ISP_LSC_TABLE_DATA_V10(pconfig->b_data_tbl[i + j], 0);
        rkisp1_iowrite32(params_vdev, data, CIF_ISP_LSC_B_TABLE_DATA);
    }
    isp_lsc_table_sel = (isp_lsc_status & CIF_ISP_LSC_ACTIVE_TABLE) ? CIF_ISP_LSC_TABLE_0 : CIF_ISP_LSC_TABLE_1;
    rkisp1_iowrite32(params_vdev, isp_lsc_table_sel, CIF_ISP_LSC_TABLE_SEL);
}

static void isp_lsc_matrix_config_v12(struct rkisp_isp_params_vdev *params_vdev,
                                      const struct cifisp_lsc_config *pconfig)
{
    int i, j;
    unsigned int isp_lsc_status, sram_addr, isp_lsc_table_sel;
    ...
    for (i = 0; i < CIF_ISP_LSC_SECTORS_MAX * CIF_ISP_LSC_SECTORS_MAX; i += CIF_ISP_LSC_SECTORS_MAX) {
        ...
        for (j = 0; j < CIF_ISP_LSC_SECTORS_MAX - 1; j += 0x02) {
            ...
            data = CIF_ISP_LSC_TABLE_DATA_V12(pconfig->gr_data_tbl[i + j], pconfig->gr_data_tbl[i + j + 1]);
            rkisp1_iowrite32(params_vdev, data, CIF_ISP_LSC_GR_TABLE_DATA);

            data = CIF_ISP_LSC_TABLE_DATA_V12(pconfig->gb_data_tbl[i + j], pconfig->gb_data_tbl[i + j + 1]);
            rkisp1_iowrite32(params_vdev, data, CIF_ISP_LSC_GB_TABLE_DATA);

            data = CIF_ISP_LSC_TABLE_DATA_V12(pconfig->b_data_tbl[i + j], pconfig->b_data_tbl[i + j + 1]);
            rkisp1_iowrite32(params_vdev, data, CIF_ISP_LSC_B_TABLE_DATA);
        }

        data = CIF_ISP_LSC_TABLE_DATA_V12(pconfig->r_data_tbl[i + j], 0);
        rkisp1_iowrite32(params_vdev, data, CIF_ISP_LSC_R_TABLE_DATA);

        data = CIF_ISP_LSC_TABLE_DATA_V12(pconfig->gr_data_tbl[i + j], 0);
        rkisp1_iowrite32(params_vdev, data, CIF_ISP_LSC_GR_TABLE_DATA);

        data = CIF_ISP_LSC_TABLE_DATA_V12(pconfig->gb_data_tbl[i + j], 0);
        rkisp1_iowrite32(params_vdev, data, CIF_ISP_LSC_GB_TABLE_DATA);

        data = CIF_ISP_LSC_TABLE_DATA_V12(pconfig->b_data_tbl[i + j], 0);
        rkisp1_iowrite32(params_vdev, data, CIF_ISP_LSC_B_TABLE_DATA);
    }
    isp_lsc_table_sel = (isp_lsc_status & CIF_ISP_LSC_ACTIVE_TABLE) ? CIF_ISP_LSC_TABLE_0 : CIF_ISP_LSC_TABLE_1;
    rkisp1_iowrite32(params_vdev, isp_lsc_table_sel, CIF_ISP_LSC_TABLE_SEL);
...
static void isp_lsc_config(struct rkisp_isp_params_vdev *params_vdev, const struct cifisp_lsc_config *arg)
{
    int i;
    u32 lsc_ctrl;
    unsigned int data;
    struct rkisp_isp_params_v1x_ops *ops = (struct rkisp_isp_params_v1x_ops *)params_vdev->priv_ops;
    ...
    if (lsc_ctrl & CIF_ISP_LSC_CTRL_ENA) {
        isp_param_set_bits(params_vdev, CIF_ISP_LSC_CTRL, CIF_ISP_LSC_CTRL_ENA);
    } else {
        isp_param_clear_bits(params_vdev, CIF_ISP_LSC_CTRL, CIF_ISP_LSC_CTRL_ENA);
    }
}
...
static void isp_flt_config(struct rkisp_isp_params_vdev *params_vdev, const struct cifisp_flt_config *arg)
{
    u32 filt_mode;
    ...
    filt_mode |= CIF_ISP_FLT_CHROMA_V_MODE(arg->chr_v_mode) | CIF_ISP_FLT_CHROMA_H_MODE(arg->chr_h_mode) |
                 CIF_ISP_FLT_GREEN_STAGE1(arg->grn_stage1);
    rkisp1_iowrite32(params_vdev, filt_mode, CIF_ISP_FILT_MODE);
}

/* ISP demosaic interface function */
static void isp_bdm_config(struct rkisp_isp_params_vdev *params_vdev, const struct cifisp_bdm_config *arg)
{
    u32 bdm_th;
...
static void isp_sdg_config(struct rkisp_isp_params_vdev *params_vdev, const struct cifisp_sdg_config *arg)
{
    int i;

    rkisp1_iowrite32(params_vdev, arg->xa_pnts.gamma_dx0, CIF_ISP_GAMMA_DX_LO);
...
/* ISP GAMMA correction interface function */
static void isp_goc_config_v10(struct rkisp_isp_params_vdev *params_vdev, const struct cifisp_goc_config *arg)
{
    int i;
    struct rkisp_isp_params_v1x_config *config = (struct rkisp_isp_params_v1x_config *)params_vdev->priv_cfg;
...
static void isp_goc_config_v12(struct rkisp_isp_params_vdev *params_vdev, const struct cifisp_goc_config *arg)
{
    int i;
    u32 value;
    struct rkisp_isp_params_v1x_config *config = (struct rkisp_isp_params_v1x_config *)params_vdev->priv_cfg;
...
/* ISP Cross Talk */
static void isp_ctk_config(struct rkisp_isp_params_vdev *params_vdev, const struct cifisp_ctk_config *arg)
{
...
static void isp_awb_meas_config_v10(struct rkisp_isp_params_vdev *params_vdev, const struct cifisp_awb_meas_config *arg)
{
    u32 reg_val = 0;
    /* based on the mode,configure the awb module */
    if (arg->awb_mode == CIFISP_AWB_MODE_YCBCR) {
        /* Reference Cb and Cr */
        rkisp1_iowrite32(params_vdev, CIF_ISP_AWB_REF_CR_SET(arg->awb_ref_cr) | arg->awb_ref_cb, CIF_ISP_AWB_REF_V10);
        /* Yc Threshold */
        rkisp1_iowrite32(params_vdev,
                         CIF_ISP_AWB_MAX_Y_SET(arg->max_y) | CIF_ISP_AWB_MIN_Y_SET(arg->min_y) |
                             CIF_ISP_AWB_MAX_CS_SET(arg->max_csum) | arg->min_c,
                         CIF_ISP_AWB_THRESH_V10);
    }
    ...
    /* window offset */
    rkisp1_iowrite32(params_vdev, arg->awb_wnd.v_offs, CIF_ISP_AWB_WND_V_OFFS_V10);
    rkisp1_iowrite32(params_vdev, arg->awb_wnd.h_offs, CIF_ISP_AWB_WND_H_OFFS_V10);
    /* AWB window size */
    rkisp1_iowrite32(params_vdev, arg->awb_wnd.v_size, CIF_ISP_AWB_WND_V_SIZE_V10);
    rkisp1_iowrite32(params_vdev, arg->awb_wnd.h_size, CIF_ISP_AWB_WND_H_SIZE_V10);
    /* Number of frames */
    rkisp1_iowrite32(params_vdev, arg->frames, CIF_ISP_AWB_FRAMES_V10);
}

static void isp_awb_meas_config_v12(struct rkisp_isp_params_vdev *params_vdev, const struct cifisp_awb_meas_config *arg)
{
    u32 reg_val = 0;
    /* based on the mode,configure the awb module */
    if (arg->awb_mode == CIFISP_AWB_MODE_YCBCR) {
        /* Reference Cb and Cr */
        rkisp1_iowrite32(params_vdev, CIF_ISP_AWB_REF_CR_SET(arg->awb_ref_cr) | arg->awb_ref_cb, CIF_ISP_AWB_REF_V12);
        /* Yc Threshold */
        rkisp1_iowrite32(params_vdev,
                         CIF_ISP_AWB_MAX_Y_SET(arg->max_y) | CIF_ISP_AWB_MIN_Y_SET(arg->min_y) |
                             CIF_ISP_AWB_MAX_CS_SET(arg->max_csum) | arg->min_c,
                         CIF_ISP_AWB_THRESH_V12);
    }
...
static void isp_awb_meas_enable_v12(struct rkisp_isp_params_vdev *params_vdev, const struct cifisp_awb_meas_config *arg,
                                    bool en)
{
...
static void isp_awb_gain_config_v10(struct rkisp_isp_params_vdev *params_vdev, const struct cifisp_awb_gain_config *arg)
{
    rkisp1_iowrite32(params_vdev, CIF_ISP_AWB_GAIN_R_SET(arg->gain_green_r) | arg->gain_green_b,
                     CIF_ISP_AWB_GAIN_G_V10);

    rkisp1_iowrite32(params_vdev, CIF_ISP_AWB_GAIN_R_SET(arg->gain_red) | arg->gain_blue, CIF_ISP_AWB_GAIN_RB_V10);
}

static void isp_awb_gain_config_v12(struct rkisp_isp_params_vdev *params_vdev, const struct cifisp_awb_gain_config *arg)
{
    rkisp1_iowrite32(params_vdev, CIF_ISP_AWB_GAIN_R_SET(arg->gain_green_r) | arg->gain_green_b,
                     CIF_ISP_AWB_GAIN_G_V12);

    rkisp1_iowrite32(params_vdev, CIF_ISP_AWB_GAIN_R_SET(arg->gain_red) | arg->gain_blue, CIF_ISP_AWB_GAIN_RB_V12);
}

static void isp_aec_config_v10(struct rkisp_isp_params_vdev *params_vdev, const struct cifisp_aec_config *arg)
{
    ...
    rkisp1_iowrite32(params_vdev, arg->meas_window.h_offs, CIF_ISP_EXP_H_OFFSET_V10);
    rkisp1_iowrite32(params_vdev, arg->meas_window.v_offs, CIF_ISP_EXP_V_OFFSET_V10);
    ...
    rkisp1_iowrite32(params_vdev, CIF_ISP_EXP_H_SIZE_SET_V10(block_hsize), CIF_ISP_EXP_H_SIZE_V10);
    rkisp1_iowrite32(params_vdev, CIF_ISP_EXP_V_SIZE_SET_V10(block_vsize), CIF_ISP_EXP_V_SIZE_V10);
}

static void isp_aec_config_v12(struct rkisp_isp_params_vdev *params_vdev, const struct cifisp_aec_config *arg)
{
    u32 exp_ctrl;
    ...
    rkisp1_iowrite32(params_vdev, CIF_ISP_EXP_V_SIZE_SET_V12(block_vsize) | CIF_ISP_EXP_H_SIZE_SET_V12(block_hsize),
                     CIF_ISP_EXP_SIZE_V12);
}

static void isp_cproc_config(struct rkisp_isp_params_vdev *params_vdev, const struct cifisp_cproc_config *arg)
{
...
static void isp_hst_config_v10(struct rkisp_isp_params_vdev *params_vdev, const struct cifisp_hst_config *arg)
{
    unsigned int block_hsize, block_vsize;
    const u32 hist_weight_regs[] = {
        CIF_ISP_HIST_WEIGHT_00TO30_V10, CIF_ISP_HIST_WEIGHT_40TO21_V10, CIF_ISP_HIST_WEIGHT_31TO12_V10,
        CIF_ISP_HIST_WEIGHT_22TO03_V10, CIF_ISP_HIST_WEIGHT_13TO43_V10, CIF_ISP_HIST_WEIGHT_04TO34_V10,
    ...
    rkisp1_iowrite32(params_vdev, arg->meas_window.h_offs, CIF_ISP_HIST_H_OFFS_V10);
    rkisp1_iowrite32(params_vdev, arg->meas_window.v_offs, CIF_ISP_HIST_V_OFFS_V10);
...
static void isp_hst_config_v12(struct rkisp_isp_params_vdev *params_vdev, const struct cifisp_hst_config *arg)
{
    u32 i, j;
    u32 value;
    u32 hist_ctrl;
    ...
    hist_ctrl &= CIF_ISP_HIST_CTRL_MODE_MASK_V12 | CIF_ISP_HIST_CTRL_EN_MASK_V12;
    hist_ctrl = hist_ctrl | CIF_ISP_HIST_CTRL_INTRSEL_SET_V12(1) | CIF_ISP_HIST_CTRL_DATASEL_SET_V12(0) |
                CIF_ISP_HIST_CTRL_WATERLINE_SET_V12(0) | CIF_ISP_HIST_CTRL_AUTOSTOP_SET_V12(0) |
                CIF_ISP_HIST_CTRL_WNDNUM_SET_V12(1) | CIF_ISP_HIST_CTRL_STEPSIZE_SET_V12(arg->histogram_predivider);
    rkisp1_iowrite32(params_vdev, hist_ctrl, CIF_ISP_HIST_CTRL_V12);

    rkisp1_iowrite32(params_vdev, CIF_ISP_HIST_OFFS_SET_V12(arg->meas_window.h_offs, arg->meas_window.v_offs),
    ...
    rkisp1_iowrite32(params_vdev, CIF_ISP_HIST_SIZE_SET_V12(block_hsize, block_vsize), CIF_ISP_HIST_SIZE_V12);

    for (i = 0; i < hist_wnd_num[wnd_num_idx]; i++) {
        for (j = 0; j < hist_wnd_num[wnd_num_idx]; j++) {
            weight15x15[i * CIF_ISP_HIST_ROW_NUM_V12 + j] = arg->hist_weight[i * hist_wnd_num[wnd_num_idx] + j];
        }
    }
...
static void isp_hst_enable_v10(struct rkisp_isp_params_vdev *params_vdev, const struct cifisp_hst_config *arg, bool en)
{
    if (en) {
        ...
        isp_param_clear_bits(params_vdev, CIF_ISP_HIST_PROP_V10, CIF_ISP_HIST_PROP_MODE_MASK_V10);
    }
}

static void isp_hst_enable_v12(struct rkisp_isp_params_vdev *params_vdev, const struct cifisp_hst_config *arg, bool en)
{
    if (en) {
        ...
        isp_param_clear_bits(params_vdev, CIF_ISP_HIST_CTRL_V12,
                             CIF_ISP_HIST_CTRL_MODE_MASK_V12 | CIF_ISP_HIST_CTRL_EN_MASK_V12);
    }
}

static void isp_afm_config_v10(struct rkisp_isp_params_vdev *params_vdev, const struct cifisp_afc_config *arg)
{
    int i;
...
static void isp_afm_config_v12(struct rkisp_isp_params_vdev *params_vdev, const struct cifisp_afc_config *arg)
{
    unsigned int i;
...
static void isp_ie_config(struct rkisp_isp_params_vdev *params_vdev, const struct cifisp_ie_config *arg)
{
    u32 eff_ctrl;
    ...
    switch (arg->effect) {
        ...
        case V4L2_COLORFX_AQUA:
            ...
            rkisp1_iowrite32(params_vdev, arg->color_sel, CIF_IMG_EFF_COLOR_SEL);
            break;
        case V4L2_COLORFX_EMBOSS:
            eff_ctrl |= CIF_IMG_EFF_CTRL_MODE_EMBOSS;
            rkisp1_iowrite32(params_vdev, arg->eff_mat_1, CIF_IMG_EFF_MAT_1);
            rkisp1_iowrite32(params_vdev, arg->eff_mat_2, CIF_IMG_EFF_MAT_2);
            rkisp1_iowrite32(params_vdev, arg->eff_mat_3, CIF_IMG_EFF_MAT_3);
            break;
        case V4L2_COLORFX_SKETCH:
            eff_ctrl |= CIF_IMG_EFF_CTRL_MODE_SKETCH;
            rkisp1_iowrite32(params_vdev, arg->eff_mat_3, CIF_IMG_EFF_MAT_3);
            rkisp1_iowrite32(params_vdev, arg->eff_mat_4, CIF_IMG_EFF_MAT_4);
            rkisp1_iowrite32(params_vdev, arg->eff_mat_5, CIF_IMG_EFF_MAT_5);
            break;
...
static void isp_csm_config(struct rkisp_isp_params_vdev *params_vdev, bool full_range)
{
    const u16 full_range_coeff[] = {0x0026, 0x004b, 0x000f, 0x01ea, 0x01d6, 0x0040, 0x0040, 0x01ca, 0x01f6};
    const u16 limited_range_coeff[] = {
        0x0021, 0x0040, 0x000d, 0x01ed, 0x01db, 0x0038, 0x0038, 0x01d1, 0x01f7,
    };
    unsigned int i;
...
static void isp_dpf_config(struct rkisp_isp_params_vdev *params_vdev, const struct cifisp_dpf_config *arg)
{
    ...
    switch (arg->gain.mode) {
        case CIFISP_DPF_GAIN_USAGE_NF_GAINS:
            isp_dpf_mode = CIF_ISP_DPF_MODE_USE_NF_GAIN | CIF_ISP_DPF_MODE_AWB_GAIN_COMP;
            break;
        ...
        case CIFISP_DPF_GAIN_USAGE_NF_LSC_GAINS:
            isp_dpf_mode =
                CIF_ISP_DPF_MODE_USE_NF_GAIN | CIF_ISP_DPF_MODE_AWB_GAIN_COMP | CIF_ISP_DPF_MODE_LSC_GAIN_COMP;
            break;
        case CIFISP_DPF_GAIN_USAGE_AWB_GAINS:
            isp_dpf_mode = CIF_ISP_DPF_MODE_AWB_GAIN_COMP;
            break;
        case CIFISP_DPF_GAIN_USAGE_AWB_LSC_GAINS:
            isp_dpf_mode = CIF_ISP_DPF_MODE_LSC_GAIN_COMP | CIF_ISP_DPF_MODE_AWB_GAIN_COMP;
            break;
    ...
    rkisp1_iowrite32(params_vdev, arg->gain.nf_b_gain, CIF_ISP_DPF_NF_GAIN_B);
    rkisp1_iowrite32(params_vdev, arg->gain.nf_r_gain, CIF_ISP_DPF_NF_GAIN_R);
    rkisp1_iowrite32(params_vdev, arg->gain.nf_gb_gain, CIF_ISP_DPF_NF_GAIN_GB);
...
static void isp_dummy_enable(struct rkisp_isp_params_vdev *params_vdev, bool en)
{
}

static void isp_wdr_config_v10(struct rkisp_isp_params_vdev *params_vdev, const struct cifisp_wdr_config *arg)
{
}

static void isp_wdr_config_v12(struct rkisp_isp_params_vdev *params_vdev, const struct cifisp_wdr_config *arg)
{
    int i;
...
static void isp_wdr_enable_v12(struct rkisp_isp_params_vdev *params_vdev, bool en)
{
    if (en) {
        rkisp1_iowrite32(params_vdev, 0x030cf1, CIF_ISP_RKWDR_CTRL0);
    } else {
        rkisp1_iowrite32(params_vdev, 0x030cf0, CIF_ISP_RKWDR_CTRL0);
    }
}

static void isp_demosaiclp_config_v10(struct rkisp_isp_params_vdev *params_vdev,
                                      const struct cifisp_demosaiclp_config *arg)
{
}

static void isp_demosaiclp_config_v12(struct rkisp_isp_params_vdev *params_vdev,
                                      const struct cifisp_demosaiclp_config *arg)
{
    u32 val;
    u32 level_sel;
    ...
    rkisp1_iowrite32(params_vdev, arg->th_csc, CIF_ISP_FILT_TH_CSC);
    rkisp1_iowrite32(params_vdev, arg->th_var, CIF_ISP_FILT_TH_VAR);

    val = CIF_ISP_PACK_4BYTE(arg->thvar_r_fct, arg->thdiff_r_fct, arg->thgrad_r_fct, 0);
    rkisp1_iowrite32(params_vdev, val, CIF_ISP_FILT_R_FCT);
...
static void isp_demosaiclp_enable_v12(struct rkisp_isp_params_vdev *params_vdev, bool en)
{
    if (en) {
        isp_param_clear_bits(params_vdev, CIF_ISP_FILT_LELEL_SEL, CIF_ISP_FLT_LEVEL_OLD_LP);
    } else {
        isp_param_set_bits(params_vdev, CIF_ISP_FILT_LELEL_SEL, CIF_ISP_FLT_LEVEL_OLD_LP);
    }
}

static void isp_rkiesharp_config_v10(struct rkisp_isp_params_vdev *params_vdev,
                                     const struct cifisp_rkiesharp_config *arg)
{
}

static void isp_rkiesharp_config_v12(struct rkisp_isp_params_vdev *params_vdev,
                                     const struct cifisp_rkiesharp_config *arg)
{
    u32 i;
    u32 val;
                                               ...
                                               const struct rkisp1_isp_params_cfg *new_params)
{
    ...
    is_grey_sensor = in_fmt->mbus_code == MEDIA_BUS_FMT_Y8_1X8 || in_fmt->mbus_code == MEDIA_BUS_FMT_Y10_1X10 ||
    ...
    if (ie_enable && iesharp_enable) {
        ...
        dev_err(params_vdev->dev->dev, "You can only use one mode in IE and RK_IESHARP!\n");
    }
    ...
    if ((module_en_update & CIFISP_MODULE_DPCC) || (module_cfg_update & CIFISP_MODULE_DPCC)) {
        ...
        if (module_en_update & CIFISP_MODULE_DPCC) {
            if (!!(module_ens & CIFISP_MODULE_DPCC)) {
                isp_param_set_bits(params_vdev, CIF_ISP_DPCC_MODE, CIF_ISP_DPCC_ENA);
            } else {
    ...
    if ((module_en_update & CIFISP_MODULE_BLS) || (module_cfg_update & CIFISP_MODULE_BLS)) {
        /* update bls config */
        ...
        if (module_en_update & CIFISP_MODULE_BLS) {
            if (!!(module_ens & CIFISP_MODULE_BLS)) {
                isp_param_set_bits(params_vdev, CIF_ISP_BLS_CTRL, CIF_ISP_BLS_ENA);
            } else {
    ...
    if ((module_en_update & CIFISP_MODULE_SDG) || (module_cfg_update & CIFISP_MODULE_SDG)) {
        /* update sdg config */
    ...
    if ((module_en_update & CIFISP_MODULE_LSC) || (module_cfg_update & CIFISP_MODULE_LSC)) {
        /* update lsc config */
    ...
    if ((module_en_update & CIFISP_MODULE_AWB_GAIN) || (module_cfg_update & CIFISP_MODULE_AWB_GAIN)) {
        /* update awb gains */
        if ((module_cfg_update & CIFISP_MODULE_AWB_GAIN)) {
            ops->awb_gain_config(params_vdev, &new_params->others.awb_gain_config);
        }
    ...
    if (((module_en_update & CIFISP_MODULE_BDM) || (module_cfg_update & CIFISP_MODULE_BDM)) && !is_grey_sensor) {
        /* update bdm config */
        ...
        if (module_en_update & CIFISP_MODULE_BDM) {
            if (!!(module_ens & CIFISP_MODULE_BDM)) {
                isp_param_set_bits(params_vdev, CIF_ISP_DEMOSAIC, CIF_ISP_DEMOSAIC_BYPASS);
            } else {
                isp_param_clear_bits(params_vdev, CIF_ISP_DEMOSAIC, CIF_ISP_DEMOSAIC_BYPASS);
            }
        }
    }

    if ((module_en_update & CIFISP_MODULE_DEMOSAICLP) || (module_cfg_update & CIFISP_MODULE_DEMOSAICLP)) {
        /* update demosaiclp  config */
        if ((module_cfg_update & CIFISP_MODULE_DEMOSAICLP)) {
            ops->demosaiclp_config(params_vdev, &new_params->others.demosaiclp_config);
        }

        if (module_en_update & CIFISP_MODULE_DEMOSAICLP) {
            ops->demosaiclp_enable(params_vdev, !!(module_ens & CIFISP_MODULE_DEMOSAICLP));
        }
    }

    if ((module_en_update & CIFISP_MODULE_FLT) || (module_cfg_update & CIFISP_MODULE_FLT)) {
        ...
        if (module_en_update & CIFISP_MODULE_FLT) {
            if (!!(module_ens & CIFISP_MODULE_FLT)) {
                isp_param_set_bits(params_vdev, CIF_ISP_FILT_MODE, CIF_ISP_FLT_ENA);
            } else {
    ...
    if ((module_en_update & CIFISP_MODULE_CTK) || (module_cfg_update & CIFISP_MODULE_CTK)) {
        /* update ctk config */
        ...
        if (module_en_update & CIFISP_MODULE_CTK) {
            ops->ctk_enable(params_vdev, !!(module_ens & CIFISP_MODULE_CTK));
        }
    }

    if ((module_en_update & CIFISP_MODULE_GOC) || (module_cfg_update & CIFISP_MODULE_GOC)) {
        /* update goc config */
        ...
        if (module_en_update & CIFISP_MODULE_GOC) {
            if (!!(module_ens & CIFISP_MODULE_GOC)) {
                isp_param_set_bits(params_vdev, CIF_ISP_CTRL, CIF_ISP_CTRL_ISP_GAMMA_OUT_ENA);
            } else {
                isp_param_clear_bits(params_vdev, CIF_ISP_CTRL, CIF_ISP_CTRL_ISP_GAMMA_OUT_ENA);
            }
        }
    }

    if ((module_en_update & CIFISP_MODULE_CPROC) || (module_cfg_update & CIFISP_MODULE_CPROC)) {
        /* update cproc config */
        if ((module_cfg_update & CIFISP_MODULE_CPROC)) {
            ops->cproc_config(params_vdev, &new_params->others.cproc_config);
        }
        if (module_en_update & CIFISP_MODULE_CPROC) {
            if (!!(module_ens & CIFISP_MODULE_CPROC)) {
                isp_param_set_bits(params_vdev, CIF_C_PROC_CTRL, CIF_C_PROC_CTR_ENABLE);
            } else {
                isp_param_clear_bits(params_vdev, CIF_C_PROC_CTRL, CIF_C_PROC_CTR_ENABLE);
            }
        }
    }

    if (((module_en_update & CIFISP_MODULE_IE) || (module_cfg_update & CIFISP_MODULE_IE)) && ie_enable) {
        /* update ie config */
    ...
    if (((module_en_update & CIFISP_MODULE_RK_IESHARP) || (module_cfg_update & CIFISP_MODULE_RK_IESHARP)) &&
        iesharp_enable) {
        /* update rkiesharp config */
        if ((module_cfg_update & CIFISP_MODULE_RK_IESHARP)) {
            ops->rkiesharp_config(params_vdev, &new_params->others.rkiesharp_config);
        }
    }
    ...
    if ((module_en_update & CIFISP_MODULE_DPF) || (module_cfg_update & CIFISP_MODULE_DPF)) {
        /* update dpf  config */
        ...
        if (module_en_update & CIFISP_MODULE_DPF) {
            if (!!(module_ens & CIFISP_MODULE_DPF)) {
                isp_param_set_bits(params_vdev, CIF_ISP_DPF_MODE, CIF_ISP_DPF_MODE_EN);
            } else {
                isp_param_clear_bits(params_vdev, CIF_ISP_DPF_MODE, CIF_ISP_DPF_MODE_EN);
            }
        }
    }

    if ((module_en_update & CIFISP_MODULE_DPF_STRENGTH) || (module_cfg_update & CIFISP_MODULE_DPF_STRENGTH)) {
        /* update dpf strength config */
        ops->dpf_strength_config(params_vdev, &new_params->others.dpf_strength_config);
    }
    ...
    if ((module_en_update & CIFISP_MODULE_WDR) || (module_cfg_update & CIFISP_MODULE_WDR)) {
        ...
        if (module_en_update & CIFISP_MODULE_WDR) {
            ops->wdr_enable(params_vdev, !!(module_ens & CIFISP_MODULE_WDR));
        }
    }
}
                                              ...
                                              struct rkisp1_isp_params_cfg *new_params)
{
    ...
    if ((module_en_update & CIFISP_MODULE_AWB) || (module_cfg_update & CIFISP_MODULE_AWB)) {
        /* update awb config */
        if ((module_cfg_update & CIFISP_MODULE_AWB)) {
            ops->awb_meas_config(params_vdev, &new_params->meas.awb_meas_config);
        }

        if (module_en_update & CIFISP_MODULE_AWB) {
            ops->awb_meas_enable(params_vdev, &new_params->meas.awb_meas_config, !!(module_ens & CIFISP_MODULE_AWB));
        }
    }

    if ((module_en_update & CIFISP_MODULE_AFC) || (module_cfg_update & CIFISP_MODULE_AFC)) {
        /* update afc config */
    ...
    if ((module_en_update & CIFISP_MODULE_HST) || (module_cfg_update & CIFISP_MODULE_HST)) {
        /* update hst config */
        ...
        if (module_en_update & CIFISP_MODULE_HST) {
            ops->hst_enable(params_vdev, &new_params->meas.hst_config, !!(module_ens & CIFISP_MODULE_HST));
        }
    }

    if ((module_en_update & CIFISP_MODULE_AEC) || (module_cfg_update & CIFISP_MODULE_AEC)) {
        /* update aec config */
...
static MAYBE_UNUSED void _preisp_isr_update_hdrae_para(struct rkisp_isp_params_vdev *params_vdev,
                                                       struct rkisp1_isp_params_cfg *new_params)
{
    ...
    if ((module_en_update & CIFISP_MODULE_LSC) || (module_cfg_update & CIFISP_MODULE_LSC)) {
        /* update lsc config */
        if ((module_cfg_update & CIFISP_MODULE_LSC)) {
            memcpy(hdrae->lsc_table, lsc->gr_data_tbl, PREISP_LSCTBL_SIZE);
        }
    ...
    ret = v4l2_subdev_call(params_vdev->dev->hdr.sensor, core, ioctl, PREISP_CMD_SAVE_HDRAE_PARAM, hdrae);
    if (ret) {
...
static const struct cifisp_awb_meas_config awb_params_default_config = {
    {0, 0, RKISP_DEFAULT_WIDTH, RKISP_DEFAULT_HEIGHT}, CIFISP_AWB_MODE_YCBCR, 200, 30, 20, 20, 0, 128, 128};

static const struct cifisp_aec_config aec_params_default_config = {
    CIFISP_EXP_MEASURING_MODE_0,
    CIFISP_EXP_CTRL_AUTOSTOP_0,
    {RKISP_DEFAULT_WIDTH >> 2, RKISP_DEFAULT_HEIGHT >> 2, RKISP_DEFAULT_WIDTH >> 1, RKISP_DEFAULT_HEIGHT >> 1}};
...
static const struct cifisp_afc_config afc_params_default_config = {1, {{300, 225, 200, 150}}, 4, 14};
...
static void rkisp1_params_first_cfg_v1x(struct rkisp_isp_params_vdev *params_vdev)
{
    ...
    if (params_vdev->dev->isp_ver == ISP_V12 || params_vdev->dev->isp_ver == ISP_V13) {
        isp_param_set_bits(params_vdev, CIF_ISP_HIST_CTRL_V12,
                           ~CIF_ISP_HIST_CTRL_MODE_MASK_V12 | hst_params_default_config.mode);
    } else {
        isp_param_set_bits(params_vdev, CIF_ISP_HIST_PROP_V10,
                           ~CIF_ISP_HIST_PROP_MODE_MASK_V10 | hst_params_default_config.mode);
    }

    /* disable color related config for grey sensor */
    if (params_vdev->in_mbus_code == MEDIA_BUS_FMT_Y8_1X8 || params_vdev->in_mbus_code == MEDIA_BUS_FMT_Y10_1X10 ||
    ...
    if (!params_vdev->isp1x_params->module_cfg_update && !params_vdev->isp1x_params->module_en_update) {
        dev_warn(dev, "can not get first iq setting in stream on\n");
    }

    _isp_isr_other_config(params_vdev, params_vdev->isp1x_params);
    _isp_isr_meas_config(params_vdev, params_vdev->isp1x_params);
    _preisp_isr_update_hdrae_para(params_vdev, params_vdev->isp1x_params);
...
static void rkisp1_get_param_size_v1x(struct rkisp_isp_params_vdev *params_vdev, unsigned int sizes[])
{
...
static void rkisp1_params_isr_v1x(struct rkisp_isp_params_vdev *params_vdev, u32 isp_mis)
{
    struct rkisp1_isp_params_cfg *new_params;
    struct rkisp_buffer *cur_buf = NULL;
    unsigned int cur_frame_id = atomic_read(&params_vdev->dev->isp_sdev.frm_sync_seq) - 1;
    ...
    if (isp_mis & CIF_ISP_FRAME) {
        ...
        _isp_isr_other_config(params_vdev, new_params);
        _isp_isr_meas_config(params_vdev, new_params);
        ...
        _preisp_isr_update_hdrae_para(params_vdev, new_params);
