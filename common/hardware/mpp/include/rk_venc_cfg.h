...
MPP_RET mpp_enc_cfg_set_s32(MppEncCfg cfg, const char *name, signed int val);
MPP_RET mpp_enc_cfg_set_u32(MppEncCfg cfg, const char *name, unsigned int val);
...
MPP_RET mpp_enc_cfg_get_s32(MppEncCfg cfg, const char *name, signed int *val);
MPP_RET mpp_enc_cfg_get_u32(MppEncCfg cfg, const char *name, unsigned int *val);
