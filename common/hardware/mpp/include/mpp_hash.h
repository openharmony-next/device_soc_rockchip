...
static inline unsigned int hash_32(unsigned int val, unsigned int bits)
{
    ...
    unsigned int hash = val * GOLDEN_RATIO_32;
...
static inline unsigned int hash_64(RK_U64 val, unsigned int bits)
{
    ...
    return hash_32((unsigned int)val ^ ((val >> 32) * GOLDEN_RATIO_32), bits);
#endif
}
...
static inline unsigned int hash32_ptr(const void *ptr)
{
