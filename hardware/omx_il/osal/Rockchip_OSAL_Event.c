...
OMX_ERRORTYPE Rockchip_OSAL_SignalWait(OMX_HANDLETYPE eventHandle, OMX_U32 ms)
{
    ...
    tv_us = now.tv_usec + ms * 1000; // 1000:time shift
    timeout.tv_sec = now.tv_sec + tv_us / 1000000; // 1000000:time shift
    timeout.tv_nsec = (tv_us % 1000000) * 1000; // 1000000:time shift, 1000:time shift
