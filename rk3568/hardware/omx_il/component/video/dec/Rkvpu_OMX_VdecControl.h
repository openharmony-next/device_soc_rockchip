...
#ifdef USE_ANB
OMX_ERRORTYPE Rkvpu_Shared_ANBBufferToData(ROCKCHIP_OMX_DATABUFFER *pUseBuffer,
    ROCKCHIP_OMX_DATA *pData, ROCKCHIP_OMX_BASEPORT *pRockchipPort, ROCKCHIP_OMX_PLANE nPlane);
OMX_ERRORTYPE Rkvpu_Shared_DataToANBBuffer(ROCKCHIP_OMX_DATA *pData,
    ROCKCHIP_OMX_DATABUFFER *pUseBuffer, ROCKCHIP_OMX_BASEPORT *pRockchipPort);
#endif
