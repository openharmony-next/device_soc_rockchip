                ...
                case OMX_StateLoaded:
                    ...
                    for (i = 0; i < ALL_PORT_NUM; i++) {
                        if (pRockchipComponent->pRockchipPort[i].portWayType == WAY1_PORT) {
                            Rockchip_OSAL_MutexTerminate(pRockchipComponent->pRockchipPort[i].way.port1WayDataBuffer. \
                                dataBuffer.bufferMutex);
                            ...
                            Rockchip_OSAL_MutexTerminate(pRockchipComponent->pRockchipPort[i].way.port2WayDataBuffer. \
                                inputDataBuffer.bufferMutex);
                            pRockchipComponent->pRockchipPort[i].way.port2WayDataBuffer.inputDataBuffer. \
                                bufferMutex = NULL;
                            Rockchip_OSAL_MutexTerminate(pRockchipComponent->pRockchipPort[i].way.port2WayDataBuffer. \
                                outputDataBuffer.bufferMutex);
                            pRockchipComponent->pRockchipPort[i].way.port2WayDataBuffer.outputDataBuffer. \
                                bufferMutex = NULL;
                        }
                    ...
                    if (pRockchipComponent->bMultiThreadProcess == OMX_FALSE) {
                        ...
                        for (i = 0; i < ALL_PORT_NUM; i++) {
                            ...
                            if (pRockchipComponent->pRockchipPort[i].bufferProcessType == BUFFER_SHARE) {
                                Rockchip_OSAL_SignalTerminate(pRockchipComponent->pRockchipPort[i]. \
                ...
                case OMX_StateIdle:
                    ...
                    for (i = 0; i < ALL_PORT_NUM; i++) {
                        if (pRockchipComponent->pRockchipPort[i].portWayType == WAY1_PORT) {
                            ...
                            Rockchip_OSAL_MutexTerminate(pRockchipComponent->pRockchipPort[i].way.port2WayDataBuffer. \
                                inputDataBuffer.bufferMutex);
                            pRockchipComponent->pRockchipPort[i].way.port2WayDataBuffer. \
                                inputDataBuffer.bufferMutex = NULL;
                            Rockchip_OSAL_MutexTerminate(pRockchipComponent->pRockchipPort[i].way.port2WayDataBuffer. \
                                outputDataBuffer.bufferMutex);
                            pRockchipComponent->pRockchipPort[i].way.port2WayDataBuffer. \
                                outputDataBuffer.bufferMutex = NULL;
                        }
                        Rockchip_OSAL_MutexTerminate(pRockchipComponent->pRockchipPort[i].hPortMutex);
                        pRockchipComponent->pRockchipPort[i].hPortMutex = NULL;
                        Rockchip_OSAL_MutexTerminate(pRockchipComponent->pRockchipPort[i].secureBufferMutex);
                ...
                case OMX_StateLoaded:
                    ...
                    if (pRockchipComponent->bMultiThreadProcess == OMX_FALSE) {
                        ...
                        for (i = 0; i < ALL_PORT_NUM; i++) {
                            ...
                            if (pRockchipComponent->pRockchipPort[i].bufferProcessType == BUFFER_SHARE)
                                Rockchip_OSAL_SignalCreate(&pRockchipComponent->pRockchipPort[i]. \
                                    hAllCodecBufferReturnEvent);
                        }
                    }
                    for (i = 0; i < ALL_PORT_NUM; i++) {
                    ...
                    for (i = 0; i < ALL_PORT_NUM; i++) {
                        if (pRockchipComponent->pRockchipPort[i].portWayType == WAY1_PORT) {
                            ret = Rockchip_OSAL_MutexCreate(&pRockchipComponent->pRockchipPort[i].way. \
                                port1WayDataBuffer.dataBuffer.bufferMutex);
                            if (ret != OMX_ErrorNone) {
                                ret = OMX_ErrorInsufficientResources;
                                omx_err("OMX_ErrorInsufficientResources, Line:%d", __LINE__);
                                goto EXIT;
                            ...
                            ret = Rockchip_OSAL_MutexCreate(&pRockchipComponent->pRockchipPort[i].way. \
                                port2WayDataBuffer.inputDataBuffer.bufferMutex);
                            if (ret != OMX_ErrorNone) {
                                ret = OMX_ErrorInsufficientResources;
                                omx_err("OMX_ErrorInsufficientResources, Line:%d", __LINE__);
                                goto EXIT;
                            ...
                            ret = Rockchip_OSAL_MutexCreate(&pRockchipComponent->pRockchipPort[i].way. \
                                port2WayDataBuffer.outputDataBuffer.bufferMutex);
                            if (ret != OMX_ErrorNone) {
                                ret = OMX_ErrorInsufficientResources;
                                omx_err("OMX_ErrorInsufficientResources, Line:%d", __LINE__);
                                goto EXIT;
                    ...
                    if (ret != OMX_ErrorNone) {
                        ...
                        for (i = 0; i < ALL_PORT_NUM; i++) {
                            if (pRockchipComponent->pRockchipPort[i].portWayType == WAY1_PORT) {
                                Rockchip_OSAL_MutexTerminate(pRockchipComponent->pRockchipPort[i].way. \
                                    port1WayDataBuffer.dataBuffer.bufferMutex);
                                pRockchipComponent->pRockchipPort[i].way.port1WayDataBuffer.dataBuffer. \
                                    bufferMutex = NULL;
                            } else if (pRockchipComponent->pRockchipPort[i].portWayType == WAY2_PORT) {
                                Rockchip_OSAL_MutexTerminate(pRockchipComponent->pRockchipPort[i].way. \
                                    port2WayDataBuffer.inputDataBuffer.bufferMutex);
        ...
        case OMX_StateExecuting:
            switch (currentState) {
                ...
                case OMX_StateIdle:
                    ...
                    for (i = 0; i < pRockchipComponent->portParam.nPorts; i++) {
                        pRockchipPort = &pRockchipComponent->pRockchipPort[i];
                        if (CHECK_PORT_TUNNELED(pRockchipPort) &&
                            CHECK_PORT_BUFFER_SUPPLIER(pRockchipPort) &&
                            CHECK_PORT_ENABLED(pRockchipPort)) {
                ...
                case OMX_StatePause:
                    for (i = 0; i < pRockchipComponent->portParam.nPorts; i++) {
                        ...
                        if (CHECK_PORT_TUNNELED(pRockchipPort) && CHECK_PORT_BUFFER_SUPPLIER(pRockchipPort) \
                            ...
                            Rockchip_OSAL_Get_SemaphoreCount(pRockchipComponent->pRockchipPort[i]. \
                                bufferSemID, &semaValue);
        ...
        if (message != NULL) {
            ...
            switch (messageType) {
                ...
                case OMX_CommandMarkBuffer:
                    ...
                    pRockchipComponent->pRockchipPort[portIndex].markType.hMarkTargetComponent =
                        ((OMX_MARKTYPE *)message->pCmdData)->hMarkTargetComponent;
                    pRockchipComponent->pRockchipPort[portIndex].markType.pMarkData            =
                        ((OMX_MARKTYPE *)message->pCmdData)->pMarkData;
                    break;
        ...
        case OMX_IndexParamCompBufferSupplier: {
            ...
            if (pRockchipPort->portDefinition.eDir == OMX_DirInput) {
                if (bufferSupplier->eBufferSupplier == OMX_BufferSupplyInput) {
                    ...
                    ret = OMX_SetParameter(pRockchipPort->tunneledComponent,
                        OMX_IndexParamCompBufferSupplier, bufferSupplier);
                    goto EXIT;
