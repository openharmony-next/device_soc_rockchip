...
void rga_rgb2nv12(RockchipVideoPlane *plane,  VPUMemLinear_t *vpumem, uint32_t Width, uint32_t Height,
    uint32_t dstWidth, uint32_t dstHeight, void *rga_ctx);
...
void rga_nv122rgb(RockchipVideoPlane *planes, VPUMemLinear_t *vpumem, uint32_t mWidth,
    uint32_t mHeight, int dst_format, void *rga_ctx);
