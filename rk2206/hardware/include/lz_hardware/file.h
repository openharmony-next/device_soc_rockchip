 ...
 * @file file.h
 *
 * @brief Performs operations on a file, including to open, close, write and read a file.
 *
 * @since 1.0
 * @version 1.0
 */

#ifndef LZ_HARDWARE_FILE_H
#define LZ_HARDWARE_FILE_H
...
/**
 * @brief Defines the offset position used by {@link ToyFileSeek}
...
/**
 * @brief Defines a flag used by{@link ToyFileOpen} to open a file in read-only mode.
 *
 */
#ifndef O_RDONLY_FS
...
/**
 * @brief Defines a flag used by {@link ToyFileOpen} to open a file in write-only mode.
 *
 */
#ifndef O_WRONLY_FS
...
/**
 * @brief Defines a flag used by {@link ToyFileOpen} to open a file in read-and-write mode.
 *
 */
#ifndef O_RDWR_FS
#define O_RDWR_FS    02
...
/**
 * @brief Defines a flag used by {@link ToyFileOpen} to create a file when the file to open does not exist.
 *
 */
#ifndef O_CREAT_FS
...
/**
 * @brief Defines a flag used by {@link ToyFileOpen} to check whether the file to open exists
...
/**
 * @brief Defines a flag used by {@link ToyFileOpen} to clear the file content
...
/**
 * @brief Defines a flag used by {@link ToyFileOpen} to start reading or writing from the end of a file.
 *
 */
#ifndef O_APPEND_FS
 ...
 * @version 1.0
 */
int ToyFileOpen(const char* path, int oflag, int mode);
 ...
 * @version 1.0
 */
int ToyFileRead(int fd, char* buf, unsigned int len);
 ...
 * @version 1.0
 */
int ToyFileWrite(int fd, const char* buf, unsigned int len);
 ...
 * @version 1.0
 */
int ToyFileDelete(const char* path);
 ...
 * @version 1.0
 */
int ToyFileStat(const char* path, unsigned int* fileSize);
 ...
 * @version 1.0
 */
int ToyFileSeek(int fd, int offset, unsigned int whence);
 ...
 * @version 1.0
 */
int ToyFileCopy(const char* src, const char* dest);
 ...
 * @version 1.0
 */
int ToyFileMove(const char* src, const char* dest);
